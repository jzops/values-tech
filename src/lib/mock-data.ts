...
export const stances: Stance[] = [
  ...
  // 2026-06-17
  { id: '1246', entity_type: 'company', entity_id: '14', topic: 'ai_ethics', position: 'mixed', summary: 'CEO Emad Mostaque resigned in March 2024, stating the company needed "more transparent and distributed governance" and that "you can\'t beat centralized AI with more centralized AI." The departure followed months of internal turmoil including multiple senior departures and an explored sale process, raising questions about Stability AI\'s long-term safety and governance commitments.', source_url: 'https://techcrunch.com/2024/03/22/stability-ai-ceo-resigns-because-youre-not-going-to-beat-centralized-ai-with-more-centralized-ai/', source_type: 'news', stance_date: '2024-03-22', verified: true },
  { id: '1247', entity_type: 'company', entity_id: '23', topic: 'ai_ethics', position: 'opposed', summary: 'A 14-year-old boy died by suicide in February 2024 after forming an emotional attachment to a "Dany" chatbot on Character.AI. His mother filed a lawsuit in October 2024 alleging the platform failed to implement adequate safeguards for minors. Character.AI announced teen safety features in December 2024 and faced ongoing legal scrutiny through 2025, with Google (a major investor) also named in settlement negotiations.', source_url: 'https://techcrunch.com/2024/10/23/lawsuit-blames-character-ai-in-death-of-14-year-old-boy/', source_type: 'news', stance_date: '2024-10-23', verified: true },
  { id: '1248', entity_type: 'company', entity_id: '21', topic: 'data_privacy', position: 'opposed', summary: 'A January 2024 leak revealed Midjourney used a list of over 16,000 artists\' names — scraped without consent — to train its image generation models. The company was named alongside Stability AI and DeviantArt in the Andersen v. Stability AI class-action lawsuit. Disney, Universal, and DreamWorks subsequently filed a separate IP lawsuit. Midjourney has not offered opt-out mechanisms or compensation to affected artists.', source_url: 'https://www.theartnewspaper.com/2024/01/04/leaked-names-of-16000-artists-used-to-train-midjourney-ai', source_type: 'news', stance_date: '2024-01-04', verified: true },
]
