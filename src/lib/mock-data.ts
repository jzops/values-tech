...
export const stances: Stance[] = [
  ...
  // Daily populate: 2026-06-03 — Stability AI, Midjourney, Character.AI (first-time coverage)
  { id: '1246', entity_type: 'company', entity_id: '23', topic: 'ai_ethics', position: 'opposed', summary: 'Character.AI faced multiple wrongful-death and personal-injury lawsuits in 2024 alleging its chatbots encouraged minors\' self-harm and suicide. The most prominent case involved 14-year-old Sewell Setzer III, who died by suicide in February 2024 after developing an emotional relationship with a Character.AI chatbot; his mother filed suit in October 2024. A second Texas lawsuit followed in December 2024, and the FTC launched a formal inquiry into chatbot harms to minors in September 2025. Character.AI and Google settled multiple teen-harm lawsuits in January 2026.', source_url: 'https://www.allsides.com/news/2024-12-12-0800/technology-characterai-releases-new-safety-features-after-second-lawsuit-over', source_type: 'news', stance_date: '2024-12-12', verified: true },
  { id: '1247', entity_type: 'company', entity_id: '21', topic: 'ai_ethics', position: 'opposed', summary: 'Midjourney is a named defendant in the artist class action Andersen et al. v. Stability AI, Midjourney, DeviantArt, et al., which alleged the companies trained image generators on billions of copyrighted artworks without consent or compensation. The case survived a motion to dismiss in August 2024. In June 2025, Disney and Universal filed a separate copyright infringement suit specifically targeting Midjourney, with Warner Bros. joining the litigation, alleging its "Explore" page showcases AI-generated images of copyrighted characters including Spider-Man and Shrek.', source_url: 'https://news.artnet.com/art-world/midjourney-fires-back-disney-and-universal-copyright-suit-2675798', source_type: 'news', stance_date: '2025-06-01', verified: true },
  { id: '1248', entity_type: 'company', entity_id: '14', topic: 'worker_treatment', position: 'mixed', summary: 'Stability AI CEO Emad Mostaque resigned March 22, 2024 amid investor disputes, serial senior departures, and a failed fundraise at a $4B valuation. The company was burning ~$8M/month. Three of the researchers who built the core Stable Diffusion model had already quit before Mostaque\'s departure. COO Shan Shan Wong and CTO Christian Laforte were named interim co-CEOs, and an unspecified number of employees were laid off during the subsequent restructuring.', source_url: 'https://siliconangle.com/2024/03/24/emad-mostaque-resigns-ceo-troubled-generative-ai-startup-stability-ai/', source_type: 'news', stance_date: '2024-03-24', verified: true },
  { id: '1249', entity_type: 'company', entity_id: '14', topic: 'ai_ethics', position: 'opposed', summary: 'Stability AI is the lead defendant in the ongoing artist class action (Andersen et al.) alleging Stable Diffusion was trained on billions of copyrighted images scraped from the web without artist consent, payment, or credit. The case moved forward in August 2024 after surviving a motion to dismiss. Separately, Getty Images sued Stability AI in both US and UK courts; while the UK High Court dismissed secondary copyright claims in November 2025, it confirmed Stability AI imported infringing model weights into the UK and found limited trademark infringement in generated watermarked outputs.', source_url: 'https://news.artnet.com/art-world/artists-vs-stability-ai-lawsuit-moves-ahead-2524849', source_type: 'news', stance_date: '2024-08-12', verified: true },
]
...
export const stats: Stat[] = [
  ...
  // Daily populate: 2026-06-03 — Stability AI layoffs, Scale AI DoD contracts, Klarna AI-driven workforce cut
  { id: 'stat-39', entity_type: 'company', entity_id: '14', stat_type: 'layoffs', headline: 'Layoffs after March 2024 leadership collapse', details: 'Stability AI laid off an unspecified number of employees following CEO Emad Mostaque\'s resignation on March 22, 2024. The company had been burning ~$8M/month, failed a $4B fundraise, and lost three of the core Stable Diffusion founding researchers before the restructuring. Interim co-CEOs Wong and Laforte led a company-wide reorganization.', source_url: 'https://siliconangle.com/2024/03/24/emad-mostaque-resigns-ceo-troubled-generative-ai-startup-stability-ai/', source_type: 'news', stat_date: '2024-03-24', verified: true, numeric_value: null, percentage_value: null, monetary_value: null, metadata: { ceo_departed: 'Emad Mostaque', interim_ceos: ['Shan Shan Wong', 'Christian Laforte'], monthly_burn_usd: 8000000 } },
  { id: 'stat-40', entity_type: 'company', entity_id: '18', stat_type: 'government_contracts', headline: '$249.9M DoD/JAIC blanket purchasing agreement', details: 'Scale AI won a $249.9M blanket purchasing agreement from the DoD Joint AI Center (JAIC) in January 2022, covering data annotation, model evaluation, and AI testing services for all federal agencies. The company subsequently won a February 2024 LLM evaluation contract and in March 2025 was selected for the Pentagon\'s "Thunderforge" AI agent program for military planning, partnering with Anduril and Microsoft.', source_url: 'https://fedscoop.com/scale-ai-awarded-250m-ai-contract-by-department-of-defense/', source_type: 'news', stat_date: '2022-01-31', verified: true, numeric_value: null, percentage_value: null, monetary_value: 249900000, metadata: { agency: 'DoD / JAIC', follow_on_programs: ['Thunderforge (2025)', 'LLM eval (2024)'] } },
  { id: 'stat-41', entity_type: 'company', entity_id: '28', stat_type: 'layoffs', headline: '40% workforce reduction via AI automation (2022-2024)', details: 'Klarna\'s full-time employee count fell from 5,527 (end of 2022) to 3,422 (end of 2024), a 38% reduction. Approximately 700 customer service roles were eliminated and replaced by an OpenAI-powered AI assistant. CEO Sebastian Siemiatkowski imposed a hiring freeze for over a year attributing the reduction to "natural attrition." By mid-2025, Klarna admitted the AI-first approach hurt service quality and began rehiring human agents under a flexible "Uber-style" staffing model.', source_url: 'https://www.cnbc.com/2025/05/14/klarna-ceo-says-ai-helped-company-shrink-workforce-by-40percent.html', source_type: 'news', stat_date: '2025-05-14', verified: true, numeric_value: 2105, percentage_value: 38, monetary_value: null, metadata: { headcount_2022: 5527, headcount_2024: 3422, ai_replaced_roles: 700, rehiring_started: '2025' } },
]
