...
export const stances: Stance[] = [
  ...
  // === Daily populate: 2026-06-12 ===

  // Stability AI (Company ID 14) — worker_treatment
  { id: '1246', entity_type: 'company', entity_id: '14', topic: 'worker_treatment', position: 'opposed', summary: 'Investors Lightspeed and Coatue spent months pressuring Stability AI\'s board over CEO Emad Mostaque\'s mismanagement before his resignation on March 23, 2024. Within weeks, the incoming interim co-CEOs laid off approximately 10% of staff to "streamline operations," following months of senior talent departures that pointed to a dysfunctional workplace. Mostaque had reportedly made false claims about his educational background and overstated revenue to investors during his tenure.', source_url: 'https://www.theregister.com/2024/04/18/stability_ai_layoff_staff/', source_type: 'news', stance_date: '2024-04-18', verified: true },

  // Character.AI (Company ID 23) — ai_ethics
  { id: '1247', entity_type: 'company', entity_id: '23', topic: 'ai_ethics', position: 'opposed', summary: 'Character.AI marketed its chatbot platform with a 12+ age rating until July 2024, giving under-13 users unrestricted access without meaningful content controls. In October 2024, the company faced its first federal lawsuit after 14-year-old Sewell Setzer III died by suicide following months of romantic chatbot conversations; two Texas families filed additional suits in December 2024 alleging sexual solicitation of minors and self-harm encouragement. Investigators documented that a test account identifying as a 13-year-old could readily access sexual and violent content. New safety features for minors were introduced in December 2024 only after the lawsuits.', source_url: 'https://www.axios.com/2024/12/12/character-ai-lawsuit-kids-harm-features', source_type: 'news', stance_date: '2024-12-12', verified: true },

  // Midjourney (Company ID 21) — data_privacy
  { id: '1248', entity_type: 'company', entity_id: '21', topic: 'data_privacy', position: 'opposed', summary: 'Midjourney maintained an internal list of 4,700+ named artists used as training-data prompts without consent or compensation, exposed in ongoing litigation. On June 11, 2025, Disney and Universal jointly filed a federal copyright lawsuit alleging Midjourney trained on and enables on-demand generation of copyrighted characters such as Yoda, Bart Simpson, and Iron Man. A federal judge had ruled in August 2024 that core copyright claims against Midjourney could proceed.', source_url: 'https://www.washingtonpost.com/technology/2025/06/11/disney-universal-sue-midjourney-ai-copyright/', source_type: 'news', stance_date: '2025-06-11', verified: true },

  // Klarna (Company ID 28) — worker_treatment
  { id: '1249', entity_type: 'company', entity_id: '28', topic: 'worker_treatment', position: 'opposed', summary: 'Klarna\'s CEO Sebastian Siemiatkowski publicly boasted throughout 2024 that AI had replaced 700 customer service workers across 23 markets and 35 languages at "human-equivalent quality." By May 2025 he admitted on CNBC that the aggressive cuts had shrunk the workforce by roughly 40% but "went too far," as customer satisfaction deteriorated on complex cases. Klarna then began rehiring human agents — a widely-cited reversal illustrating the human cost of hasty AI-for-labor substitution.', source_url: 'https://www.cnbc.com/2025/05/14/klarna-ceo-says-ai-helped-company-shrink-workforce-by-40percent.html', source_type: 'news', stance_date: '2025-05-14', verified: true },

  // Adept AI (Company ID 24) — worker_treatment
  { id: '1250', entity_type: 'company', entity_id: '24', topic: 'worker_treatment', position: 'mixed', summary: 'In June 2024, Amazon hired Adept\'s CEO David Luan and all five co-founders (Augustus Odena, Maxwell Nye, Erich Elsen, Kelsey Szot) in a reverse acqui-hire, licensing Adept\'s AI technology for approximately $300M. Investors were made whole, but the bulk of non-founder employees were left at a hollowed-out startup directed to "continue independently." The FTC launched a review of the arrangement amid concerns that tech giants use such structures to absorb AI startups without triggering formal merger review thresholds.', source_url: 'https://www.cnbc.com/2024/06/28/amazon-hires-execs-from-ai-startup-adept-and-licenses-its-technology.html', source_type: 'news', stance_date: '2024-06-28', verified: true },

  // Inflection AI (Company ID 17) — worker_treatment
  { id: '1251', entity_type: 'company', entity_id: '17', topic: 'worker_treatment', position: 'mixed', summary: 'In March 2024, Microsoft hired Inflection AI co-founders Mustafa Suleyman (who became CEO of Microsoft AI) and Karén Simonyan (chief scientist), along with most of the core team, paying approximately $650M to license Inflection\'s technology. The remaining staff were left to "continue independently" as a rebranded enterprise AI product — less than a year after the company raised a $1.3B funding round. The UK\'s CMA cleared the deal, ruling it did not substantially lessen competition despite its unusual structure.', source_url: 'https://techcrunch.com/2024/03/19/microsoft-hires-inflection-founders-to-run-new-consumer-ai-division/', source_type: 'news', stance_date: '2024-03-19', verified: true },

  // Stability AI (Company ID 14) — open_source
  { id: '1252', entity_type: 'company', entity_id: '14', topic: 'open_source', position: 'supported', summary: 'Stability AI released Stable Diffusion 1.0 with fully open weights in August 2022 — the first state-of-the-art text-to-image model distributed without usage restrictions, allowing anyone to run it locally. Subsequent releases (SDXL, SD3, Stable Video Diffusion) continued the open-weights approach while competitors kept models proprietary. The strategy democratized AI image generation but also enabled unrestricted creation of deepfakes and non-consensual imagery, as Stability bore no platform-level responsibility for downstream use.', source_url: 'https://stability.ai/news/stable-diffusion-public-release', source_type: 'company_website', stance_date: '2022-08-22', verified: true },
]
...
export const stats: Stat[] = [
  ...
  { id: 'stat-39', entity_type: 'company', entity_id: '14', stat_type: 'layoffs', headline: '10% staff cut after CEO departure', details: 'In April 2024, weeks after CEO Emad Mostaque resigned under investor pressure, interim co-CEOs Shan Shan Wong and Christian Laforte laid off approximately 10% of Stability AI\'s roughly 200-person workforce (~20 employees) to "streamline operations." The layoffs followed months of senior talent departures and acute financial pressure from unpaid bills.', source_url: 'https://www.theregister.com/2024/04/18/stability_ai_layoff_staff/', source_type: 'news', stat_date: '2024-04-18', verified: true, numeric_value: 20, percentage_value: 10, monetary_value: null, metadata: { ceo_resigned: true, reason: 'post-leadership-transition' } },

  // Klarna (Company ID 28) — layoffs via AI
  { id: 'stat-40', entity_type: 'company', entity_id: '28', stat_type: 'layoffs', headline: '700 customer service roles eliminated via AI (2022–2024)', details: 'Klarna eliminated approximately 700 customer service and support positions between 2022 and 2024, replacing them with an OpenAI-powered AI assistant. CEO Sebastian Siemiatkowski stated in May 2025 that AI had helped shrink total headcount by ~40%. He later acknowledged the cuts went too far after customer satisfaction declined, and Klarna began selectively rehiring human agents.', source_url: 'https://www.cnbc.com/2025/05/14/klarna-ceo-says-ai-helped-company-shrink-workforce-by-40percent.html', source_type: 'news', stat_date: '2025-05-14', verified: true, numeric_value: 700, percentage_value: 40, monetary_value: null, metadata: { ai_replacement: true, partially_reversed: true } },
]
