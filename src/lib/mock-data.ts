...
export const stances: Stance[] = [
  ...
  // Daily populate: 2026-05-08
  { id: '1246', entity_type: 'company', entity_id: '247', topic: 'data_privacy', position: 'opposed', summary: '23andMe filed Chapter 11 bankruptcy on March 23, 2025, putting the genetic data of 15+ million customers at risk of sale without their consent. CEO Anne Wojcicki resigned the same day. A bipartisan coalition of 28 state AGs led by New York AG Letitia James sued to block the data sale. Website traffic surged 526% as 1.9 million users ultimately deleted their data. The bankruptcy exposed a gap in US federal law protecting genetic information in insolvency proceedings.', source_url: 'https://ag.ny.gov/press-release/2025/attorney-general-james-sues-23andme-protect-new-yorkers-genetic-data', source_type: 'press_release', stance_date: '2025-03-24', verified: true },
  { id: '1247', entity_type: 'company', entity_id: '257', topic: 'ai_ethics', position: 'mixed', summary: 'In February 2025, Figure AI CEO Brett Adcock ended the company\'s collaboration with OpenAI, stating Figure had achieved a "major breakthrough" in fully end-to-end robot AI built entirely in-house. Adcock: "LLMs are getting smarter yet more commoditized — external AI partnerships are ultimately irrelevant to our success." Figure continued its BMW Spartanburg deployment, with Figure 02 robots contributing to production of 30,000+ BMW X3 vehicles with >99% placement accuracy. Building proprietary models without external safety partners raises open questions about oversight.', source_url: 'https://x.com/adcock_brett/status/1886860098980733197', source_type: 'social_media', stance_date: '2025-02-04', verified: true },
  { id: '1248', entity_type: 'company', entity_id: '242', topic: 'government_contracts', position: 'supported', summary: 'In August 2025, Ukraine\'s Ministry of Defence formally designated Shield AI a "verified business partner," granting it access to state procurement contracts. By April 2025, Shield AI V-BAT drones had completed 130+ sorties in Ukraine, identifying 200+ Russian military targets including two HQs. Shield AI opened a Kyiv office in January 2025, staffed by engineers and mission operations personnel, and began direct training of Ukrainian Unmanned Systems Forces. Shield AI also raised its valuation to $5.6B during 2025.', source_url: 'https://shield.ai/shield-ai-surpasses-130-v-bat-sorties-in-ukraine-in-partnership-with-ukrainian-forces/', source_type: 'company_website', stance_date: '2025-08-01', verified: true },
  { id: '1249', entity_type: 'company', entity_id: '22', topic: 'government_contracts', position: 'supported', summary: 'In November 2025, GSA and Perplexity signed a first-of-its-kind direct OneGov agreement making Perplexity Enterprise Pro for Government available to all US federal agencies. Perplexity became one of only two AI platforms designated for government AI Prioritization, expediting its FedRAMP cloud authorization. The deal supports the White House\'s America\'s AI Action Plan and connects federal workers to a multi-model AI research tool with real-time cited answers and integrations to agency systems.', source_url: 'https://www.gsa.gov/about-gsa/newsroom/news-releases/gsa-perplexity-sign-first-direct-to-gov-deal-11192025', source_type: 'press_release', stance_date: '2025-11-19', verified: true },
]
...
export const stats: Stat[] = [
  ...
  // Daily populate: 2026-05-08
  { id: 'stat-39', entity_type: 'company', entity_id: '247', stat_type: 'layoffs', headline: '40% workforce cut in November 2024 restructuring', details: '23andMe cut 40% of its workforce (200+ employees) in November 2024, discontinuing its entire therapeutics division and all clinical and preclinical programs. The board\'s seven independent directors resigned before the announcement. The company disclosed "substantial doubt about its ability to continue as a going concern" in SEC filings, foreshadowing the March 2025 Chapter 11 bankruptcy.', source_url: 'https://www.cnn.com/2024/11/11/business/23andme-reduce-workforce/index.html', source_type: 'news', stat_date: '2024-11-12', verified: true, numeric_value: null, percentage_value: 40, monetary_value: null, metadata: { annualized_savings: 35000000, division_closed: 'therapeutics' } },
  { id: 'stat-40', entity_type: 'company', entity_id: '22', stat_type: 'government_contracts', headline: 'First direct US government AI contract via GSA OneGov', details: 'GSA and Perplexity signed a first-of-its-kind OneGov agreement in November 2025, making Perplexity Enterprise Pro for Government available to all US federal agencies on GSA\'s Multiple Award Schedule. Perplexity became one of only two AI services designated for government AI Prioritization, accelerating its FedRAMP authorization. The deal connects federal workers to a multi-model research tool with real-time cited answers and optional connections to SharePoint, OneDrive, and Outlook.', source_url: 'https://www.gsa.gov/about-gsa/newsroom/news-releases/gsa-perplexity-sign-first-direct-to-gov-deal-11192025', source_type: 'government_record', stat_date: '2025-11-19', verified: true, numeric_value: null, percentage_value: null, monetary_value: null, metadata: { agency: 'GSA', program: 'OneGov', term_months: 18 } },
]
