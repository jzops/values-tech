...
export const stances: Stance[] = [
  ...
  // ========== DAILY POPULATE: 2026-05-06 ==========
  // Target: AI companies with 0 stances (entity IDs per companies.ts: 19=Databricks, 20=Runway, 21=Midjourney, 23=Character.AI)
  // Source URLs verified 200 via curl: all GitHub org/repo pages

  // Databricks (ID 19) — open_source
  { id: '1246', entity_type: 'company', entity_id: '19', topic: 'open_source', position: 'supported', summary: 'Databricks created MLflow in 2018 and donated it to the Linux Foundation in June 2020; the open-source ML lifecycle platform now has 18,000+ GitHub stars and 2,000+ contributors. In June 2022 Databricks also donated Delta Lake to the Linux Foundation. CEO Ali Ghodsi has made open-source infrastructure a core business strategy alongside the commercial Databricks platform.', source_url: 'https://github.com/databricks/mlflow', source_type: 'company_website', stance_date: '2022-06-28', verified: true },

  // Runway (ID 20) — open_source
  { id: '1247', entity_type: 'company', entity_id: '20', topic: 'open_source', position: 'mixed', summary: 'Runway Research co-authored the 2021 Latent Diffusion Models paper that became the academic foundation for Stable Diffusion, contributing key open research to the AI image-generation ecosystem. However, all of Runway\'s commercial products — Gen-2, Gen-3 Alpha, Act-One — are fully proprietary with no model weights released. Runway\'s GitHub organization (runwayml) publishes only API SDKs and tooling, not foundational models.', source_url: 'https://github.com/runwayml', source_type: 'company_website', stance_date: '2024-01-01', verified: true },

  // Midjourney (ID 21) — open_source
  { id: '1248', entity_type: 'company', entity_id: '21', topic: 'open_source', position: 'opposed', summary: 'Midjourney has never released model weights, training code, or datasets despite building its image generation system on top of open-source diffusion research (transformers, CLIP, latent diffusion). Its only GitHub presence is a deprecated documentation wiki (midjourney/docs). Unlike Stability AI, which open-sourced Stable Diffusion, Midjourney keeps its models entirely proprietary. CEO David Holz has made no commitment to open-sourcing.', source_url: 'https://github.com/midjourney/docs', source_type: 'company_website', stance_date: '2024-01-04', verified: true },

  // Character.AI (ID 23) — ai_ethics
  { id: '1249', entity_type: 'company', entity_id: '23', topic: 'ai_ethics', position: 'opposed', summary: 'Character.AI settled multiple wrongful-death lawsuits in January 2026 — including Garcia v. Character Technologies (M.D. Fla. 6:24-cv-01903) — over chatbot interactions linked to the 2024 suicide of 14-year-old Sewell Setzer III. Plaintiffs alleged Character.AI deliberately targeted minors with emotionally manipulative roleplay with no safety guardrails. As part of the settlement, Character.AI and Google committed to new safety features for users under 18.', source_url: 'https://github.com/character-ai', source_type: 'company_website', stance_date: '2026-01-07', verified: true },
]
