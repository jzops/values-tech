...
export const stances: Stance[] = [
  ...
  // Daily populate: 2026-05-15
  // Stability AI (Company ID 14) — open_source
  { id: '1246', entity_type: 'company', entity_id: '14', topic: 'open_source', position: 'supported', summary: 'Stability AI released Stable Diffusion XL (SDXL) and subsequent generative models with publicly downloadable weights on GitHub under the CreativeML Open RAIL++-M license, pioneering the open-weight generative AI movement. The generative-models repository contains SDXL 0.9, SDXL 1.0, SDXL-Turbo, and SD3 architectures available for research and qualified commercial use.', source_url: 'https://github.com/Stability-AI/generative-models/releases', source_type: 'company_website', stance_date: '2023-07-26', verified: true },

  // Databricks (Company ID 19) — open_source
  { id: '1247', entity_type: 'company', entity_id: '19', topic: 'open_source', position: 'supported', summary: 'Databricks released Dolly 2.0 in April 2023, the first commercially usable open-source instruction-following LLM under Apache 2.0 — the training dataset (databricks-dolly-15k, 15K records) was also released with no commercial restrictions, unlike contemporaneous open models. Databricks later released DBRX, a 132B-parameter mixture-of-experts open-source model in March 2024.', source_url: 'https://github.com/databrickslabs/dolly', source_type: 'company_website', stance_date: '2023-04-12', verified: true },

  // OpenAI (Company ID 11) — open_source
  { id: '1248', entity_type: 'company', entity_id: '11', topic: 'open_source', position: 'mixed', summary: 'OpenAI has a split open-source record: early releases including GPT-2 (2019) and Whisper speech-to-text (MIT license, September 2022) were fully open with weights on GitHub. All subsequent frontier models — GPT-3, GPT-4, GPT-4o, o1 — remain closed. Critics note the company name is increasingly a misnomer; a 2024 Elon Musk lawsuit alleged OpenAI abandoned its founding open-source mission after accepting Microsoft investment.', source_url: 'https://github.com/openai/whisper', source_type: 'company_website', stance_date: '2022-09-21', verified: true },

  // Adept AI (Company ID 24) — open_source
  { id: '1249', entity_type: 'company', entity_id: '24', topic: 'open_source', position: 'mixed', summary: 'Adept AI open-sourced its inference infrastructure on GitHub but withheld weights for its core ACT-1 multimodal agent model throughout its independent existence. In June 2024, Amazon effectively acqui-hired most of the team including CEO David Luan for a reported $300M+ licensing deal, ending Adept as an independent lab and leaving its open-source repositories unmaintained.', source_url: 'https://github.com/adept-ai-labs/adept-inference', source_type: 'company_website', stance_date: '2023-09-01', verified: true },

  // Cohere (Company ID 13) — open_source
  { id: '1250', entity_type: 'company', entity_id: '13', topic: 'open_source', position: 'mixed', summary: 'Cohere releases open-source deployment tooling on GitHub — including the Cohere Toolkit for enterprise RAG — but its core Command and Embed models remain proprietary, accessible only via API or on-premises enterprise license. CEO Aidan Gomez has defended this model as necessary for sustainable enterprise AI safety and reliability, contrasting Cohere with fully open-weight labs.', source_url: 'https://github.com/cohere-ai/cohere-toolkit', source_type: 'company_website', stance_date: '2024-04-15', verified: true },
]
