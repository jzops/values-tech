...
export const stances: Stance[] = [
  ...
  // ========== DAILY POPULATE: 2026-06-09 ==========

  // Runway (Company ID 20) - ai_ethics
  { id: '1246', entity_type: 'company', entity_id: '20', topic: 'ai_ethics', position: 'opposed', summary: 'In July 2024, leaked internal data showed Runway scraped 100,000+ YouTube videos from studios including Pixar, Disney, Netflix, and Sony without consent to train its Gen-3 Alpha video model, violating YouTube\'s Terms of Service. A YouTube creator filed a proposed class action (Gardner v. Runway AI, No. 2:26-cv-01941, C.D. Cal.) in February 2026 alleging DMCA anti-circumvention violations; Runway faces at least four separate copyright suits.', source_url: 'https://venturebeat.com/ai/runway-faces-backlash-after-report-of-copying-ai-video-training-data-from-youtube', source_type: 'news', stance_date: '2024-07-25', verified: true },

  // Adept AI (Company ID 24) - antitrust
  { id: '1247', entity_type: 'company', entity_id: '24', topic: 'antitrust', position: 'mixed', summary: 'In June 2024, Amazon hired Adept AI\'s founders and approximately 80% of its 100-person team in a reverse acqui-hire, licensing the technology rather than triggering a formal acquisition. The FTC opened an informal inquiry in July 2024 over whether the deal was structured to evade HSR merger-disclosure requirements. Sen. Ron Wyden cited the arrangement as a pattern of Big Tech using acqui-hire structures to escape antitrust review.', source_url: 'https://www.cnbc.com/2024/07/16/amazons-deal-with-ai-startup-adept-faces-ftc-scrutiny.html', source_type: 'news', stance_date: '2024-07-16', verified: true },

  // Jasper AI (Company ID 25) - worker_treatment
  { id: '1248', entity_type: 'company', entity_id: '25', topic: 'worker_treatment', position: 'opposed', summary: 'Jasper cut an undisclosed number of employees in July 2023 — less than a year after raising $125M at a $1.5B valuation — as ChatGPT competition drove its 2023 ARR forecast down by 30%. Co-founder and CEO Dave Rogenmoser was pushed out and replaced by former Dropbox president Timothy Young in September 2023, and the company cut its internal valuation 20% to $1.2B, leaving employees with diluted equity against the original fundraise promises.', source_url: 'https://www.bloomberg.com/news/articles/2023-09-28/ai-startup-jasper-s-ceo-to-be-replaced-with-ex-dropbox-president', source_type: 'news', stance_date: '2023-07-17', verified: true },

  // Revolut (Company ID 29) - data_privacy
  { id: '1249', entity_type: 'company', entity_id: '29', topic: 'data_privacy', position: 'opposed', summary: 'In September 2022, a social engineering attack on a third-party system exposed personal data of 50,000+ Revolut customers, including names, addresses, email addresses, and partial payment card details; the Lithuanian Data Protection Inspectorate confirmed the breach. In late 2024, a separate incident emerged in which a former Revolut employee allegedly threatened to expose customer KYC data unless paid a cryptocurrency ransom, prompting Revolut to cooperate with law enforcement.', source_url: 'https://www.securityweek.com/over-50000-revolut-customers-affected-data-breach/', source_type: 'news', stance_date: '2022-09-16', verified: true },

  // Nubank (Company ID 33) - worker_treatment
  { id: '1250', entity_type: 'company', entity_id: '33', topic: 'worker_treatment', position: 'opposed', summary: 'In November 2025, Nubank ended its near-total remote-work policy, announcing mandatory hybrid attendance of two days/week from July 2026 rising to three days/week from January 2027. When employees criticized the policy in a company-wide meeting, 12 were fired for "aggressive behavior" — a move the Brazilian Banking Workers Union publicly condemned. CEO David Vélez cited "invisible costs" to organizational culture as justification.', source_url: 'https://www.bloomberg.com/news/articles/2025-11-06/nubank-to-bring-workers-back-into-the-office-more-days-a-week', source_type: 'news', stance_date: '2025-11-06', verified: true },
]
...
export const stats: Stat[] = [
  ...
  // Jasper AI (Company ID 25) - layoffs
  { id: 'stat-39', entity_type: 'company', entity_id: '25', stat_type: 'layoffs', headline: 'Staff cuts; ARR forecast slashed 30%', details: 'Jasper AI cut an undisclosed number of employees in July 2023, less than a year after closing a $125M Series A at a $1.5B valuation. The company simultaneously revised its 2023 ARR forecast down by at least 30% — from ~$140M to under $100M — as ChatGPT commoditized AI content generation. CEO and co-founder Dave Rogenmoser departed in September 2023, and the internal valuation was cut from $1.5B to $1.2B.', source_url: 'https://www.bloomberg.com/news/articles/2023-09-28/ai-startup-jasper-s-ceo-to-be-replaced-with-ex-dropbox-president', source_type: 'news', stat_date: '2023-07-17', verified: true, numeric_value: null, percentage_value: null, monetary_value: null, metadata: { arr_forecast_cut_pct: 30, valuation_before: 1500000000, valuation_after: 1200000000 } },

  // Affirm (Company ID 38) - layoffs
  { id: 'stat-40', entity_type: 'company', entity_id: '38', stat_type: 'layoffs', headline: '500 employees cut (19% of workforce)', details: 'Affirm Holdings cut approximately 500 employees (19% of workforce) on February 8, 2023, alongside an earnings miss. The company expected $35–39M in total restructuring costs including $24–28M in cash severance. A second round in February 2024 cut 140 additional workers (~6%) through consolidation of operations teams, bringing total 2023–2024 reductions to ~640 employees.', source_url: 'https://www.sec.gov/Archives/edgar/data/0001820953/000182095323000001/afrm-20230208.htm', source_type: 'sec_filing', stat_date: '2023-02-08', verified: true, numeric_value: 500, percentage_value: 19, monetary_value: null, metadata: { rounds: 2, second_round_cuts: 140, second_round_pct: 6, restructuring_cost_usd: 37000000 } },

  // Nubank (Company ID 33) - remote_policy
  { id: 'stat-41', entity_type: 'company', entity_id: '33', stat_type: 'remote_policy', headline: 'Ending remote-first; hybrid mandate phased in 2026–2027', details: 'Nubank announced in November 2025 it will phase out its near-total remote work model: employees must work in-office two days per week from July 1, 2026, increasing to three days per week from January 1, 2027. CEO David Vélez cited "invisible costs" to organizational culture as the driver. Permanent exceptions apply to specific roles including Investor Help, Data Labeling, and Financial Crime Investigation.', source_url: 'https://www.bloomberg.com/news/articles/2025-11-06/nubank-to-bring-workers-back-into-the-office-more-days-a-week', source_type: 'news', stat_date: '2025-11-06', verified: true, numeric_value: 3, percentage_value: null, monetary_value: null, metadata: { days_required: 3, phase_in_date: '2026-07-01', full_mandate_date: '2027-01-01' } },
]
