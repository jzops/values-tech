...
export const stances: Stance[] = [
  ...
  // 2026-05-21 Daily populate: Inflection AI, Adept AI, Perplexity AI
  { id: '1246', entity_type: 'company', entity_id: '17', topic: 'antitrust', position: 'opposed', summary: 'In March 2024, Microsoft paid $650M ($620M licensing fee + $30M non-sue agreement) to hire virtually all of Inflection AI\'s staff — including cofounders Mustafa Suleyman and Karén Simonyan — without filing as a merger. The FTC opened an antitrust probe in June 2024 and the UK\'s CMA launched its own investigation in July 2024, both examining whether the deal was deliberately structured to sidestep the $119M merger-reporting threshold.', source_url: 'https://techcrunch.com/2024/07/16/microsoft-faces-uk-antitrust-probe-after-hiring-inflection-ai-founders-and-employees/', source_type: 'news', stance_date: '2024-07-16', verified: true },
  { id: '1247', entity_type: 'company', entity_id: '24', topic: 'antitrust', position: 'opposed', summary: 'In June 2024, Amazon hired Adept AI\'s five cofounders (David Luan, Augustus Odena, Maxwell Nye, Erich Elsen, Kelsey Szot) plus roughly two-thirds of its staff while paying Adept a $25M technology licensing fee — leaving only ~20 employees behind. The FTC launched an informal inquiry and Sen. Ron Wyden cited the deal in a letter to the FTC and DOJ as an example of Big Tech using pseudo-acquisitions to evade antitrust filing thresholds.', source_url: 'https://techcrunch.com/2024/06/28/amazon-hires-founders-away-from-ai-startup-adept/', source_type: 'news', stance_date: '2024-06-28', verified: true },
  { id: '1248', entity_type: 'company', entity_id: '22', topic: 'antitrust', position: 'opposed', summary: 'The New York Times sued Perplexity AI on December 5, 2025 for large-scale copyright infringement, alleging it systematically scraped and reproduced Times journalism to power a commercial AI search product. News Corp, Nikkei, Asahi Shimbun, Encyclopedia Britannica, and Reddit filed or joined similar suits in 2025. The Times alleged Perplexity bypassed its robots.txt blocks using disguised user agents and hidden IP addresses to continue crawling the site after being hard-blocked.', source_url: 'https://techcrunch.com/2025/12/05/the-new-york-times-is-suing-perplexity-for-copyright-infringement/', source_type: 'news', stance_date: '2025-12-05', verified: true },
]
...
export const stats: Stat[] = [
  ...
  // 2026-05-21 Daily populate: Klarna AI-driven layoffs
  { id: 'stat-39', entity_type: 'company', entity_id: '28', stat_type: 'layoffs', headline: 'AI-driven 38% headcount reduction', details: 'Klarna\'s headcount fell from 5,527 full-time employees at end of 2022 to 3,422 by December 2024 — a 38% reduction — with CEO Sebastian Siemiatkowski crediting AI for much of the shrinkage. An OpenAI-powered assistant was said to do the work of ~700 customer service agents. After customer satisfaction deteriorated, Klarna reversed course in 2025, admitting cost-optimization had gone "too far" and beginning to rehire human staff.', source_url: 'https://www.cnbc.com/2025/05/14/klarna-ceo-says-ai-helped-company-shrink-workforce-by-40percent.html', source_type: 'news', stat_date: '2024-12-31', verified: true, numeric_value: 3422, percentage_value: 38, monetary_value: null, metadata: { employees_peak: 5527, employees_2024: 3422, ai_replaced_roles: 700 } },
]
