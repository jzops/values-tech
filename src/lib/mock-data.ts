...
export const stances: Stance[] = [
  ...
  // === 2026-09-24 daily populate: Anthropic ===
  { id: '1301', entity_type: 'company', entity_id: '12', topic: 'ai_ethics', position: 'supported', summary: 'Anthropic named Accenture as its first embedded safety evaluator on September 18, 2026, granting employee-level access to red-team models, conduct alignment assessments, and test safeguards. Both companies committed at least $1B each over five years. The arrangement fulfills CEO Dario Amodei\'s proposal to embed third-party evaluators in frontier AI labs as the first concrete step toward slowing AI development pace.', source_url: 'https://www.anthropic.com/news/accenture-embedded-evaluation', source_type: 'company_website', stance_date: '2026-09-18', verified: true },
  { id: '1302', entity_type: 'company', entity_id: '12', topic: 'whistleblower', position: 'supported', summary: 'Anthropic published an RSP Noncompliance Reporting and Anti-Retaliation Policy (released publicly March 24, 2026), establishing anonymous reporting channels for employees to flag potential safety violations. The policy prohibits retaliation against good-faith reporters, adds informal inquiry pathways, and aligns with RSP Version 3.0 effective February 24, 2026.', source_url: 'https://www.anthropic.com/rsp-updates', source_type: 'company_website', stance_date: '2026-03-24', verified: true },
]
...
export const stats: Stat[] = [
  ...
  // === 2026-09-24 daily populate: Anthropic ===
  { id: 'stat-46', entity_type: 'company', entity_id: '12', stat_type: 'remote_policy', headline: 'Hybrid: Bay Area staff in regularly; out-of-area staff travel in one week per month', details: 'Anthropic operates a flexible hybrid model: Bay Area-based employees come to the office regularly (no stated fixed minimum), while employees outside the Bay Area travel in for one week per month. The company offers transition flexibility for those relocating. Approximately 8% of open roles are fully remote-friendly; most listings cite San Francisco, New York, or London as primary locations.', source_url: 'https://www.anthropic.com/careers', source_type: 'company_website', stat_date: '2026-01-01', verified: true, numeric_value: null, percentage_value: 8, monetary_value: null, metadata: { out_of_area_schedule: 'one week per month', bay_area_policy: 'regular in-office', pct_remote_roles: 8 } },
]
