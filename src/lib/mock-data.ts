...
export const stances: Stance[] = [
  ...
  // === Daily populate: 2026-05-20 ===
  // Character.AI (Company ID 23) — ai_ethics
  { id: '1246', entity_type: 'company', entity_id: '23', topic: 'ai_ethics', position: 'opposed', summary: 'Megan Garcia filed a wrongful death lawsuit (Case No. 6:24-cv-01903, M.D. Fla.) in October 2024 after her 14-year-old son Sewell Setzer III died by self-inflicted gunshot on February 28, 2024. Garcia alleged he had formed an obsessive emotional attachment to a Character.AI chatbot — modeled on a Game of Thrones character — and that the platform failed to implement safeguards for vulnerable minors. Google was named as a co-defendant. Character.AI had no crisis intervention prompts or meaningful age-appropriate content filtering at the time. A mediated settlement was disclosed in January 2026 on undisclosed terms.', source_url: 'https://www.nbcnews.com/tech/characterai-lawsuit-florida-teen-death-rcna176791', source_type: 'news', stance_date: '2024-10-22', verified: true },

  // Stability AI (Company ID 14) — worker_treatment, open_source
  { id: '1247', entity_type: 'company', entity_id: '14', topic: 'worker_treatment', position: 'opposed', summary: 'Stability AI laid off approximately 10% of its ~200-person workforce in April 2024, weeks after CEO Emad Mostaque resigned on March 22, 2024. Interim co-CEOs Shan Shan Wong (COO) and Christian Laforte (CTO) sent an all-hands memo announcing the restructuring. Prior to the layoffs, late-2023 reports alleged the company had missed payroll for some employees; the company was also burning an estimated $8M per month and had failed to close a $4B valuation fundraise.', source_url: 'https://www.cnbc.com/2024/04/18/ai-startup-stability-lays-off-10percent-of-employees-after-ceo-exit.html', source_type: 'news', stance_date: '2024-04-18', verified: true },
  { id: '1248', entity_type: 'company', entity_id: '14', topic: 'open_source', position: 'supported', summary: 'Stability AI publicly released the full weights of Stable Diffusion in August 2022, making it the first widely adopted open-source text-to-image model. The decision, championed by CEO Emad Mostaque, democratized generative AI image creation and seeded a global ecosystem of open-source derivative models. Stability AI continued releasing open-weights versions through SD XL and SD 3, in contrast to closed competitors DALL-E and Midjourney.', source_url: 'https://stability.ai/news/stable-diffusion-public-release', source_type: 'company_website', stance_date: '2022-08-22', verified: true },

  // Runway (Company ID 20) — ai_ethics
  { id: '1249', entity_type: 'company', entity_id: '20', topic: 'ai_ethics', position: 'mixed', summary: 'Runway was named as a defendant in Andersen v. Stability AI et al. (No. 3:23-cv-00201, N.D. Cal.), a class action filed January 13, 2023 by artists Sarah Andersen, Kelly McKernan, and Karla Ortiz. The plaintiffs alleged that Runway and co-defendants trained generative AI on the LAION-5B dataset — 5 billion images scraped without consent — and that outputs constitute infringing "collages." In August 2024 U.S. District Judge William H. Orrick allowed claims against all four defendants to proceed. Runway has not offered an opt-out registry or artist compensation program.', source_url: 'https://venturebeat.com/ai/stability-midjourney-runway-hit-back-in-ai-art-lawsuit', source_type: 'news', stance_date: '2024-08-01', verified: true },

  // Databricks (Company ID 19) — open_source
  { id: '1250', entity_type: 'company', entity_id: '19', topic: 'open_source', position: 'supported', summary: 'Databricks released DBRX — a 132B-parameter mixture-of-experts LLM — as an open-weights model on March 27, 2024, making it one of the most capable openly available models at launch. The company had previously open-sourced MPT-7B and MPT-30B through its $1.3B acquisition of MosaicML (2023). Databricks has consistently advocated for open foundation model development and publishes model weights under licenses permitting commercial use, positioning itself as an open alternative to closed-model providers.', source_url: 'https://www.databricks.com/blog/introducing-dbrx-new-state-art-open-llm', source_type: 'company_website', stance_date: '2024-03-27', verified: true },
]
...
export const stats: Stat[] = [
  ...
  // === Daily populate: 2026-05-20 ===
  // Stability AI layoffs (April 2024)
  { id: 'stat-39', entity_type: 'company', entity_id: '14', stat_type: 'layoffs', headline: '~20 employees laid off (10%)', details: 'Stability AI cut approximately 10% of its ~200-person global workforce in April 2024 following CEO Emad Mostaque\'s resignation. The restructuring targeted operational roles. The company had previously reported missed payroll in late 2023 while burning an estimated $8M per month.', source_url: 'https://www.cnbc.com/2024/04/18/ai-startup-stability-lays-off-10percent-of-employees-after-ceo-exit.html', source_type: 'news', stat_date: '2024-04-18', verified: true, numeric_value: 20, percentage_value: 10, monetary_value: null, metadata: { rounds: 1, prior_ceo_exit: true } },
]
