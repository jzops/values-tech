...
export const stances: Stance[] = [
  ...
  // ========== DAILY POPULATE: 2026-05-29 ==========
  // Character.AI — ai_ethics
  { id: '1246', entity_type: 'company', entity_id: '23', topic: 'ai_ethics', position: 'opposed', summary: 'Character.AI and Google agreed in January 2026 to settle multiple lawsuits alleging the platform\'s AI chatbots contributed to teen suicides, including the February 2024 death of 14-year-old Sewell Setzer III after monthslong emotional exchanges with an AI persona. The company lacked adequate safeguards to prevent minors from developing harmful parasocial relationships with bots, per the suits. Prior to settlement, Character.AI banned open-ended chats for under-18 users in October 2025 and launched an AI Safety Lab nonprofit.', source_url: 'https://www.cbsnews.com/news/google-settle-lawsuit-florida-teens-suicide-character-ai-chatbot/', source_type: 'news', stance_date: '2026-01-07', verified: true },

  // HashiCorp — open_source
  { id: '1247', entity_type: 'company', entity_id: '46', topic: 'open_source', position: 'opposed', summary: 'HashiCorp switched Terraform from the open-source Mozilla Public License 2.0 to the restrictive Business Source License 1.1 in August 2023, prohibiting commercial use by competitors. The community forked Terraform as OpenTofu under the Linux Foundation within weeks. Following IBM\'s $6.4B acquisition of HashiCorp (completed February 2025), IBM continued pursuing legal claims against OpenTofu contributors alleging post-fork commits incorporated proprietary HashiCorp code, a claim OpenTofu denies.', source_url: 'https://thenewstack.io/hashicorp-abandons-open-source-for-business-source-license/', source_type: 'news', stance_date: '2023-08-10', verified: true },

  // Cloudflare — data_privacy
  { id: '1248', entity_type: 'company', entity_id: '48', topic: 'data_privacy', position: 'supported', summary: 'Cloudflare publishes semi-annual transparency reports disclosing the number of government requests for user data, and has stated it has never installed law enforcement surveillance software on its network, never provided a feed of customer content to law enforcement, and never handed over encryption or authentication keys to any government. In H2 2025, Cloudflare committed to exhaust all legal remedies before complying with any request it deems unconstitutional, and continues to challenge overbroad national security letters.', source_url: 'https://blog.cloudflare.com/h1-2025-transparency-report/', source_type: 'company_website', stance_date: '2025-07-01', verified: true },

  // Perplexity AI — worker_treatment
  { id: '1249', entity_type: 'company', entity_id: '22', topic: 'worker_treatment', position: 'opposed', summary: 'Perplexity CEO Aravind Srinivas sparked public backlash in March 2026 when, on the All-In Podcast, he called AI-driven mass layoffs a "glorious future to look forward to," arguing that "most people don\'t enjoy their jobs" and job displacement creates entrepreneurship opportunities. Critics noted the remarks were dismissive of workers losing income and healthcare. Over 101,000 U.S. jobs linked to AI displacement were lost since February 2025, per trackers cited in coverage.', source_url: 'https://fortune.com/2026/03/24/perplexity-ceo-ai-layoffs-not-bad-people-hate-jobs-entrepreneurship/', source_type: 'news', stance_date: '2026-03-24', verified: true },
]
...
export const stats: Stat[] = [
  ...
  // ========== DAILY POPULATE: 2026-05-29 ==========
  { id: 'stat-39', entity_type: 'company', entity_id: '32', stat_type: 'layoffs', headline: '700 employees laid off (14%)', details: 'Coinbase announced on May 5, 2026 it would cut approximately 700 jobs — 14% of its global workforce — citing AI acceleration allowing smaller teams to handle prior headcount. CEO Brian Armstrong described the restructuring as flattening management layers, replacing "pure managers" with "player-coaches" each overseeing 15+ reports. Coinbase expects $50–60M in severance charges in Q2 2026.', source_url: 'https://www.cnbc.com/2026/05/05/coinbase-cuts-headcount-by-14percent-citing-ai-acceleration-the-shares-are-gaining.html', source_type: 'news', stat_date: '2026-05-05', verified: true, numeric_value: 700, percentage_value: 14, monetary_value: null, metadata: { rounds: 1, restructuring_charges_usd: 55000000 } },
  { id: 'stat-40', entity_type: 'company', entity_id: '46', stat_type: 'layoffs', headline: 'Mass layoffs post-IBM acquisition', details: 'Following IBM\'s $6.4B acquisition of HashiCorp (completed February 2025), HashiCorp underwent multiple rounds of undisclosed workforce reductions through early 2026. Media coverage was sparse; employee forums on Blind documented ongoing layoffs into Q1 2026. The cuts mirrored IBM\'s pattern with prior acquisitions including Red Hat, where hundreds of engineers were similarly let go after integration.', source_url: 'https://techrights.org/n/2026/03/23/Mass_Layoffs_at_HashiCorp_IBM_Hid_Them.shtml', source_type: 'news', stat_date: '2026-03-23', verified: true, numeric_value: null, percentage_value: null, monetary_value: null, metadata: { acquirer: 'IBM', acquisition_price_usd: 6400000000 } },
]
