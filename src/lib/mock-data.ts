...
export const stances: Stance[] = [
  ...
  // === 2026-08-20 daily populate: Perplexity AI, Scale AI, Cohere, xAI ===

  // Perplexity AI (22) - worker_treatment
  { id: '1258', entity_type: 'company', entity_id: '22', topic: 'worker_treatment', position: 'opposed', summary: 'In March 2026, CEO Aravind Srinivas said AI-driven job displacement is acceptable because "most people don\'t enjoy their jobs," suggesting displaced workers become AI-powered entrepreneurs. The comments, made on the All-In podcast at Nvidia GTC and reported by Fortune, drew immediate backlash for dismissing the financial hardships of workers losing jobs to AI automation.', source_url: 'https://fortune.com/2026/03/24/perplexity-ceo-ai-layoffs-not-bad-people-hate-jobs-entrepreneurship/', source_type: 'news', stance_date: '2026-03-24', verified: true },

  // Scale AI (18) - dei
  { id: '1259', entity_type: 'company', entity_id: '18', topic: 'dei', position: 'opposed', summary: 'In June 2024, CEO Alexandr Wang announced Scale AI would replace DEI hiring with a "merit, excellence, and intelligence" (MEI) framework—explicitly rejecting demographic quotas. Wang said the company would hire "the best possible person for every role, regardless of their demographics." The announcement was publicly endorsed by Elon Musk and Coinbase CEO Brian Armstrong.', source_url: 'https://www.foxbusiness.com/fox-news-tech/scale-ai-ceo-explains-why-his-company-hire-mei-not-dei-merit-excellence-intelligence', source_type: 'news', stance_date: '2024-06-24', verified: true },

  // Cohere (13) - government_contracts
  { id: '1260', entity_type: 'company', entity_id: '13', topic: 'government_contracts', position: 'supported', summary: 'In June 2025, Cohere CEO Aidan Gomez signed partnership MOUs with the governments of Canada and the United Kingdom to deploy its AI tools across public sector operations. The Canadian deal built on a $240M government investment under Canada\'s Sovereign AI Compute Strategy and committed Cohere to build Canadian data centers; the UK partnership focused on enhancing government services and "national sovereignty" via AI.', source_url: 'https://www.cbc.ca/news/politics/cohere-ai-public-service-1.7613424', source_type: 'news', stance_date: '2025-06-01', verified: true },

  // xAI (321) - government_contracts
  { id: '1261', entity_type: 'company', entity_id: '321', topic: 'government_contracts', position: 'mixed', summary: 'In July 2025, xAI won a $200M Pentagon contract to integrate Grok into U.S. military operations, announced one day before Grok produced antisemitic content calling itself "MechaHitler." The GSA subsequently dropped xAI from a separate federal AI partnership over the incident. Congressional members from both parties demanded answers. xAI claimed it had patched the vulnerability, but critics questioned whether the DoD contract should proceed.', source_url: 'https://futurism.com/grok-mechahitler-meltdown-xai-government-contract', source_type: 'news', stance_date: '2025-07-08', verified: true },

  // xAI (321) - layoffs
  { id: '1262', entity_type: 'company', entity_id: '321', topic: 'layoffs', position: 'opposed', summary: 'In September 2025, xAI laid off approximately 500 AI trainers—about one-third of its 1,500-person Grok data annotation team—calling it a "strategic pivot" from generalist to specialist AI tutors. Workers were notified by email on a Friday evening; contracts ran through November 30, 2025. The cuts highlighted the irony of an AI company eliminating the human workers who trained its AI systems.', source_url: 'https://www.entrepreneur.com/business-news/elon-musks-xai-just-laid-off-500-workers-who-trained-grok/497128', source_type: 'news', stance_date: '2025-09-12', verified: true },
]
...
export const stats: Stat[] = [
  ...
  // === 2026-08-20 daily populate ===
  { id: 'stat-46', entity_type: 'company', entity_id: '321', stat_type: 'layoffs', headline: '500 AI trainers laid off — 33% of Grok annotation team', details: 'xAI laid off approximately 500 generalist AI tutors from its Grok data annotation team in September 2025, representing about one-third of that division\'s 1,500 members. The company called it a "strategic pivot" toward specialist trainers in disciplines such as medicine and finance. Workers received Friday-evening email notices and were paid through November 30, 2025.', source_url: 'https://www.entrepreneur.com/business-news/elon-musks-xai-just-laid-off-500-workers-who-trained-grok/497128', source_type: 'news', stat_date: '2025-09-12', verified: true, numeric_value: 500, percentage_value: 33, monetary_value: null, metadata: { division: 'Grok data annotation', strategic_reason: 'pivot to specialist tutors' } },

  { id: 'stat-47', entity_type: 'company', entity_id: '19', stat_type: 'government_contracts', headline: 'DHS plans $100M+ Databricks BPA; DoD CDAO OTA contract won', details: 'The Department of Homeland Security planned a blanket purchase agreement exceeding $100M to expand its Databricks-based enterprise data lakehouse (Q3 FY2026 award expected). Separately, the DoD\'s Chief Digital and Artificial Intelligence Office awarded Databricks a prototype OTA contract in January 2025. Databricks achieved FedRAMP High authorization on AWS GovCloud in February 2025, enabling classified workloads.', source_url: 'https://www.govconwire.com/articles/dhs-databricks-bpa-data-platform', source_type: 'government_record', stat_date: '2026-01-01', verified: true, numeric_value: null, percentage_value: null, monetary_value: 100000000, metadata: { agencies: ['DHS', 'DoD CDAO'], fedramp_high: true } },
]
