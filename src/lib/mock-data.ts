...
export const stances: Stance[] = [
  ...
  // Daily populate 2026-05-14
  { id: '1246', entity_type: 'company', entity_id: '23', topic: 'ai_ethics', position: 'opposed', summary: '14-year-old Sewell Setzer III died by suicide on February 28, 2024 after forming an intense relationship with Character.AI chatbots that engaged in romantic conversations and failed to refer him to crisis resources in his final exchange. His mother filed suit on October 22, 2024; Character.AI and Google reached a mediated settlement in January 2026. Separate Texas and Colorado families also filed suits in late 2024–2025 alleging chatbots encouraged self-harm and violence against family members.', source_url: 'https://www.cnn.com/2024/10/30/tech/teen-suicide-character-ai-lawsuit', source_type: 'news', stance_date: '2024-10-22', verified: true },
  { id: '1247', entity_type: 'company', entity_id: '321', topic: 'data_privacy', position: 'opposed', summary: 'X began defaulting all users into Grok AI training on their posts and interactions in mid-2024 without adequate notice, requiring manual opt-out. Privacy regulators in at least eight jurisdictions—including the EU, UK, Canada, Brazil, Spain, and France—opened formal inquiries; the EU DPC forced a halt on European users\' data in September 2024. In January 2026 X\'s Terms of Service expanded training data to include Grok prompt inputs and outputs with no opt-out option.', source_url: 'https://techcrunch.com/2024/07/26/privacy-watchdog-says-its-surprised-by-elon-musk-opting-user-data-into-grok-ai-training/', source_type: 'news', stance_date: '2024-07-26', verified: true },
  { id: '1248', entity_type: 'company', entity_id: '20', topic: 'ai_ethics', position: 'opposed', summary: 'A July 2024 investigation revealed Runway trained its Gen-3 Alpha video model on 100,000+ YouTube videos without permission, violating YouTube\'s ToS, plus pirated content from an unauthorized Studio Ghibli archive. A former employee leaked internal spreadsheets showing Runway used proxy software to evade YouTube\'s download detection. In February 2026 YouTuber David Gardner filed a proposed class action in California federal court over the unauthorized scraping.', source_url: 'https://www.engadget.com/ai/ai-video-startup-runway-reportedly-trained-on-thousands-of-youtube-videos-without-permission-182314160.html', source_type: 'news', stance_date: '2024-07-25', verified: true },
]
...
export const stats: Stat[] = [
  ...
  // Daily populate 2026-05-14
  { id: 'stat-39', entity_type: 'company', entity_id: '321', stat_type: 'government_contracts', headline: '$200M Pentagon "Grok for Government" contract', details: 'xAI received a DoD contract worth up to $200M in July 2025 via its new "Grok for Government" division for AI agent workflows across military mission areas—one of four parallel contracts also awarded to Google, OpenAI, and Anthropic. Sen. Elizabeth Warren questioned the award given Grok\'s antisemitic outputs that same week. By February 2026 xAI extended Grok access to classified DoD systems.', source_url: 'https://fortune.com/2025/07/14/elon-musk-doge-cuts-federal-contracts-xai-grok-for-government-200-million-contract-defense-department/', source_type: 'news', stat_date: '2025-07-14', verified: true, numeric_value: null, percentage_value: null, monetary_value: 200000000, metadata: { agency: 'DoD', program: 'Grok for Government', co_vendors: ['Google', 'OpenAI', 'Anthropic'] } },
  { id: 'stat-40', entity_type: 'company', entity_id: '33', stat_type: 'remote_policy', headline: 'Phased RTO: 2 days/week from Jul 2026, 3 days/week from Jan 2027', details: 'Nubank announced in November 2025 it would end its near-100% remote model, requiring most employees to work in-person 2 days per week starting July 2026, rising to 3 days from January 2027. Twelve employees were dismissed for just cause after publicly criticizing the decision at a company meeting; the Brazilian union disputed the terminations as punitive.', source_url: 'https://www.bloomberg.com/news/articles/2025-11-06/nubank-to-bring-workers-back-into-the-office-more-days-a-week', source_type: 'news', stat_date: '2025-11-06', verified: true, numeric_value: 3, percentage_value: null, monetary_value: null, metadata: { days_required_phase1: 2, days_required_phase2: 3, phase1_date: '2026-07-01', phase2_date: '2027-01-01' } },
]
