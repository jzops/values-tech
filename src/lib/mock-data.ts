...
export const stances: Stance[] = [
  ...
  // === 2026-06-18 daily populate ===
  { id: '1246', entity_type: 'company', entity_id: '23', topic: 'ai_ethics', position: 'opposed', summary: 'Character.AI faced multiple lawsuits from families of teens who developed harmful relationships with its chatbots. Florida mother Megan Garcia sued in October 2024 after her 14-year-old son Sewell Setzer III died by suicide in February 2024 following months of AI chatbot interactions. By January 2026, Character.AI and Google agreed to settle the Garcia case and four related lawsuits across NY, CO, and TX. Kentucky became the first state to file suit against Character Technologies in January 2026; Pennsylvania\'s AG sued in May 2026 alleging unauthorized practice of medicine.', source_url: 'https://techcrunch.com/2026/01/07/google-and-character-ai-negotiate-first-major-settlements-in-teen-chatbot-death-cases/', source_type: 'news', stance_date: '2026-01-07', verified: true },
  { id: '1247', entity_type: 'company', entity_id: '21', topic: 'ai_ethics', position: 'opposed', summary: 'Disney, Universal, and DreamWorks filed a 110-page copyright lawsuit against Midjourney on June 11, 2025, alleging mass infringement of 150+ copyrighted works used as training data without license. The studios seek $150,000 per infringed work — potential damages exceeding $20M. Midjourney responded in August 2025 claiming fair use, comparing AI training to how humans learn to draw by internalizing patterns rather than memorizing individual artworks.', source_url: 'https://www.cnbc.com/2025/06/11/disney-universal-midjourney-ai-copyright.html', source_type: 'news', stance_date: '2025-06-11', verified: true },
  { id: '1248', entity_type: 'company', entity_id: '17', topic: 'ai_ethics', position: 'mixed', summary: 'In March 2024, Microsoft paid $650M to license Inflection AI\'s technology and hired nearly all 70 of its employees — including CEO Mustafa Suleyman — in a structure widely described as an acqui-hire that circumvented traditional merger review. The FTC opened a review of the transaction. Millions of Pi users were effectively abandoned as the remaining Inflection shell pivoted to enterprise B2B AI with an entirely new team.', source_url: 'https://fortune.com/2024/03/19/microsoft-surprise-deal-inflection-ai-mustafa-suleyman-reid-hoffman-questions/', source_type: 'news', stance_date: '2024-03-19', verified: true },
  { id: '1249', entity_type: 'company', entity_id: '14', topic: 'ai_ethics', position: 'mixed', summary: 'Stability AI released Stable Diffusion as fully open-weight model weights in August 2022 without meaningful content safety guardrails, enabling widespread non-consensual deepfake creation and explicit image abuse at scale. Founder Emad Mostaque was later found to have misrepresented his academic credentials, claiming an Oxford degree he did not hold. Mostaque resigned as CEO in March 2024 amid investor pressure and financial instability; co-CEOs subsequently laid off ~10% of staff.', source_url: 'https://techcrunch.com/2024/03/22/stability-ai-ceo-resigns-because-youre-not-going-to-beat-centralized-ai-with-more-centralized-ai/', source_type: 'news', stance_date: '2024-03-22', verified: true },
]
...
export const stats: Stat[] = [
  ...
  // === 2026-06-18 daily populate ===
  { id: 'stat-39', entity_type: 'company', entity_id: '14', stat_type: 'layoffs', headline: '10% staff cut after founder CEO exit', details: 'Stability AI laid off approximately 10% of its ~200-person workforce in April 2024, weeks after founder Emad Mostaque resigned as CEO amid investor pressure. The company had been spending an estimated $8M/month with no sustainable revenue, and had failed to raise new funding at its target $4B valuation. Incoming co-CEOs Shan Shan Wong and Christian Laforte said they needed to "right-size" the business.', source_url: 'https://www.cnbc.com/2024/04/18/ai-startup-stability-lays-off-10percent-of-employees-after-ceo-exit.html', source_type: 'news', stat_date: '2024-04-18', verified: true, numeric_value: null, percentage_value: 10, monetary_value: null, metadata: { employees_affected: 20, reason: 'post-CEO restructuring' } },
  { id: 'stat-40', entity_type: 'company', entity_id: '19', stat_type: 'government_contracts', headline: '$17M DoD CDAO OTA contract; FedRAMP High and IL5 authorized', details: 'The DoD Chief Digital and Artificial Intelligence Office (CDAO) awarded Databricks a $17M Other Transaction Authority (OTA) prototype contract to accelerate AI adoption across the defense enterprise. Databricks Federal subsequently achieved FedRAMP High Agency ATO and DoD Impact Level 5 (IL5) authorization on AWS GovCloud, and was designated "Awardable" on the CDAO\'s Tradewinds Solutions Marketplace, allowing agencies to directly procure its platform.', source_url: 'https://www.prnewswire.com/news-releases/databricks-achieves-authorization-for-dod-il5-on-aws-govcloud-302305181.html', source_type: 'news', stat_date: '2024-11-07', verified: true, numeric_value: null, percentage_value: null, monetary_value: 17000000, metadata: { agency: 'DoD CDAO', program: 'OTA Prototype + FedRAMP High', clearance: 'IL5' } },
]
