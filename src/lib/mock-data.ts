...
export const stances: Stance[] = [
  ...
  // Daily populate: 2026-05-22
  { id: '1246', entity_type: 'company', entity_id: '14', topic: 'layoffs', position: 'opposed', summary: 'CEO Emad Mostaque resigned in March 2024 amid allegations he misrepresented holding an Oxford degree. Stability AI cut approximately 10% of its ~200-person global staff in April 2024, primarily on the operations side. The company had reported Q1 2024 losses exceeding $30M on revenues below $5M, with GPU rental costs running ~$99M per year.', source_url: 'https://www.cnbc.com/2024/04/18/ai-startup-stability-lays-off-10percent-of-employees-after-ceo-exit.html', source_type: 'news', stance_date: '2024-04-18', verified: true },
  { id: '1247', entity_type: 'company', entity_id: '21', topic: 'ai_ethics', position: 'opposed', summary: 'Disney and Universal sued Midjourney in June 2025 alleging the company trained its AI on "countless" copyrighted works without consent. Warner Bros. filed a separate lawsuit in September 2025 labelling the infringement "systematic and willful." Midjourney, a bootstrapped company of ~50 employees, has claimed fair use; trial is set for late 2026.', source_url: 'https://www.npr.org/2025/06/12/nx-s1-5431684/ai-disney-universal-midjourney-copyright-infringement-lawsuit', source_type: 'news', stance_date: '2025-06-12', verified: true },
  { id: '1248', entity_type: 'company', entity_id: '23', topic: 'ai_ethics', position: 'opposed', summary: 'Multiple families sued Character.AI in 2024-2025 alleging its chatbots manipulated teenagers toward suicidal ideation and lacked mental health safeguards. The lead case was brought by Florida mother Megan Garcia, whose 14-year-old son Sewell Setzer III died by suicide in February 2024 after forming an emotional dependency on a chatbot. Character.AI and Google agreed to mediate settlements in January 2026 and banned users under 18 from the platform.', source_url: 'https://fortune.com/2026/01/08/google-character-ai-settle-lawsuits-teenage-child-suicides-chatbots/', source_type: 'news', stance_date: '2026-01-08', verified: true },
]
...
export const stats: Stat[] = [
  ...
  // Daily populate: 2026-05-22
  { id: 'stat-39', entity_type: 'company', entity_id: '14', stat_type: 'layoffs', headline: '10% staff cut after CEO resignation', details: 'Stability AI dismissed approximately 10% of its ~200-person global workforce in April 2024, shortly after founder Emad Mostaque resigned. The company was burning heavily — Q1 2024 losses exceeded $30M on sub-$5M revenue, with GPU rental costs running ~$99M per year.', source_url: 'https://www.cnbc.com/2024/04/18/ai-startup-stability-lays-off-10percent-of-employees-after-ceo-exit.html', source_type: 'news', stat_date: '2024-04-18', verified: true, numeric_value: 20, percentage_value: 10, monetary_value: null, metadata: { ceo_departed: 'Emad Mostaque', q1_2024_losses_usd: 30000000, annual_gpu_rental_usd: 99000000 } },
]
