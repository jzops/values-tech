...
export const stances: Stance[] = [
  ...
  // Daily populate: 2026-06-01 — AI companies with zero company stances
  { id: '1246', entity_type: 'company', entity_id: '23', topic: 'ai_ethics', position: 'opposed', summary: 'In October 2024, Megan Garcia filed a lawsuit against Character.AI and Google alleging its chatbot — modeled on a Game of Thrones character — encouraged the suicide of her 14-year-old son Sewell Setzer III, who had formed an emotionally dependent relationship with the platform despite repeatedly expressing suicidal ideation. The suit alleged Character.AI lacked adequate safeguards. In January 2026, Character.AI and Google settled this case and four other teen mental health harm lawsuits; Character.AI also banned minors from open-ended chatbot conversations by November 2025.', source_url: 'https://www.cnn.com/2024/10/30/tech/teen-suicide-character-ai-lawsuit', source_type: 'news', stance_date: '2024-10-30', verified: true },
  { id: '1247', entity_type: 'company', entity_id: '20', topic: 'data_privacy', position: 'opposed', summary: 'In July 2024, a leaked internal Runway spreadsheet revealed plans to train its Gen-3 Alpha video model on over 100,000 YouTube videos from 3,900+ channels — including MKBHD, Casey Neistat, Netflix, and VICE — without creator consent and in violation of YouTube\'s Terms of Service. The OECD AI Incident Database catalogued the case. Runway did not deny using the data and declined to address the specific spreadsheet publicly.', source_url: 'https://venturebeat.com/ai/runway-faces-backlash-after-report-of-copying-ai-video-training-data-from-youtube', source_type: 'news', stance_date: '2024-07-25', verified: true },
  { id: '1248', entity_type: 'company', entity_id: '21', topic: 'data_privacy', position: 'opposed', summary: 'In January 2023, illustrators Sarah Andersen, Kelly McKernan, and Karla Ortiz filed a class action in the Northern District of California against Midjourney, Stability AI, and DeviantArt for training on billions of copyrighted artworks without consent. A leaked internal list showed Midjourney had trained on works by over 16,000 named artists. In November 2025, Disney, NBC Universal, and DreamWorks filed a separate major IP lawsuit against Midjourney. The company has not disclosed or defended its training data practices.', source_url: 'https://news.artnet.com/art-world/class-action-lawsuit-ai-generators-deviantart-midjourney-stable-diffusion-2246770', source_type: 'news', stance_date: '2023-01-13', verified: true },
  { id: '1249', entity_type: 'company', entity_id: '24', topic: 'antitrust', position: 'mixed', summary: 'In June 2024, Amazon executed a "reverse acqui-hire" of Adept AI, hiring ~80% of its technical staff including CEO David Luan for a $330M IP license fee plus $100M in retention bonuses — a deal structure designed to avoid the merger-notification thresholds that would trigger antitrust review. The FTC sent Amazon questions about the deal\'s nature and the UK CMA opened a formal review. The arrangement mirrored Microsoft\'s near-identical dismantling of Inflection AI, which regulators on both sides of the Atlantic flagged as a merger-law evasion pattern.', source_url: 'https://fortune.com/2024/07/17/big-ai-acquihire-microsoft-inflection-amazon-adept-antitrust-cma-ftc/', source_type: 'news', stance_date: '2024-06-01', verified: true },
]
...
export const stats: Stat[] = [
  ...
  // Daily populate: 2026-06-01 — Scale AI government contracts
  { id: 'stat-39', entity_type: 'company', entity_id: '18', stat_type: 'government_contracts', headline: '$500M Pentagon CDAO contract', details: 'In May 2026, the Pentagon\'s Chief Digital and Artificial Intelligence Office (CDAO) awarded Scale AI a $500M agreement — five times its prior $100M deal — for automated data analysis and AI-aided military decision-making. The Army Contracting Command administered the contract. Scale AI (backed by Meta, Accel, and Tiger Global) has become one of the Pentagon\'s primary AI data providers.', source_url: 'https://scale.com/blog/Scale-ai-pentagon-cdao-500-million-agreement', source_type: 'company_website', stat_date: '2026-05-06', verified: true, numeric_value: null, percentage_value: null, monetary_value: 500000000, metadata: { agency: 'Pentagon CDAO', program: 'CDAO AI Data Services', prior_contract_value: 100000000 } },
]
