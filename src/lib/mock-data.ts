...
export const stances: Stance[] = [
  ...
  { id: '1289', entity_type: 'vc', entity_id: '15', topic: 'layoffs', position: 'opposed', summary: 'Insight Partners\' workforce declined 17.5% from 876 employees in 2023 to 723 in 2026. Employee reviews cite multiple rounds of layoffs with no warning, cuts to benefits and compensation, and constant reorganizations. Former employees described massive over-hiring in 2022 followed by years of cuts that eroded morale and trust.', source_url: 'https://www.reveliolabs.com/companies/insight-partners/employees/', source_type: 'news', stance_date: '2025-01-01', verified: true },
  ...
  { id: '1291', entity_type: 'person', entity_id: '57', topic: 'politics', position: 'mixed', summary: 'Robinhood CEO Vlad Tenev testified before the House Financial Services Committee on February 18, 2021, regarding the GameStop trading restrictions. Lawmakers accused Robinhood of transforming the stock market into a casino. Tenev apologized for the confusion but defended the company\'s actions as necessary due to capital requirements, not collusion with hedge funds.', source_url: 'https://www.washingtonpost.com/business/2021/02/18/gamestop-robinhood-citadel-roaring-kitty-hearing-live-updates/', source_type: 'news', stance_date: '2021-02-18', verified: true },

  // Parker Conrad (Person ID 49) - worker_treatment
  { id: '1292', entity_type: 'person', entity_id: '49', topic: 'worker_treatment', position: 'opposed', summary: 'The SEC fined Zenefits and former CEO Parker Conrad over $980,000 combined on October 26, 2017, for "materially false and misleading statements" to investors. Conrad created a computer program called "the macro" that let insurance brokers spend fewer hours on required licensing training. This was the first SEC fine against a Silicon Valley unicorn startup.', source_url: 'https://www.buzzfeednews.com/article/williamalden/the-sec-just-fined-a-unicorn-startup-for-the-first-time', source_type: 'news', stance_date: '2017-10-26', verified: true },
]
