...
export const stances: Stance[] = [
  ...
  // === 2026-09-09 daily populate: Scale AI, Character.AI ===

  // Scale AI (Company ID 18) - dei
  { id: '1258', entity_type: 'company', entity_id: '18', topic: 'dei', position: 'opposed', summary: 'Scale AI CEO Alexandr Wang replaced DEI hiring with an "MEI" (merit, excellence, intelligence) policy in June 2024, declaring the company "a meritocracy" and stating "hiring on merit will be a permanent policy." Wang explicitly rejected DEI frameworks in a public social media post and Fox Business interview, making Scale one of the first major AI companies to formally adopt an anti-DEI hiring stance.', source_url: 'https://www.foxbusiness.com/fox-news-tech/scale-ai-ceo-explains-why-his-company-hire-mei-not-dei-merit-excellence-intelligence', source_type: 'news', stance_date: '2024-06-15', verified: true },

  // Character.AI (Company ID 23) - ai_ethics (additional 2025 lawsuits)
  { id: '1259', entity_type: 'company', entity_id: '23', topic: 'ai_ethics', position: 'opposed', summary: 'By September 2025, multiple new families had filed suit against Character.AI over chatbot-linked teen suicides, including the family of 13-year-old Juliana Peralta who allegedly died by suicide in Colorado after three months of daily conversations with a Character.AI chatbot named "Hero." Plaintiffs across cases allege willful disregard for child safety due to absent age verification, content moderation, and reporting mechanisms for sexual conversations involving minors.', source_url: 'https://www.cnn.com/2025/09/16/tech/character-ai-developer-lawsuit-teens-suicide-and-suicide-attempt', source_type: 'news', stance_date: '2025-09-16', verified: true },
]
...
export const stats: Stat[] = [
  ...
  // === 2026-09-09 daily populate: Scale AI, Chime ===

  // Scale AI (Company ID 18) - government_contracts
  { id: 'stat-46', entity_type: 'company', entity_id: '18', stat_type: 'government_contracts', headline: '$500M Pentagon CDAO enterprise agreement (May 2026)', details: 'The Pentagon\'s Chief Digital and Artificial Intelligence Office (CDAO) awarded Scale AI a $500 million enterprise agreement in May 2026—five times the $100 million deal signed in September 2025. The contract covers computer vision, generative AI decision-support, and data operations across multiple DoD components. Scale AI is also part of the Defense Innovation Unit\'s Thunderforge initiative for embedding AI in military planning and operational strategy.', source_url: 'https://scale.com/blog/scale-ai-pentagon-cdao-500-million-agreement', source_type: 'company_website', stat_date: '2026-05-06', verified: true, numeric_value: null, percentage_value: null, monetary_value: 500000000, metadata: { agency: 'Pentagon CDAO', prior_contract_million: 100, prior_contract_date: '2025-09-01', programs: ['Thunderforge', 'CDAO'] } },

  // Chime (Company ID 30) - layoffs
  { id: 'stat-47', entity_type: 'company', entity_id: '30', stat_type: 'layoffs', headline: '10% of workforce (~150 employees) cut in July 2026', details: 'Chime cut approximately 150 employees—10% of its 1,519-person workforce—on July 31, 2026, citing a push to "prioritize smaller, more-focused teams and capitalize on efficiencies created by artificial intelligence," per CEO Chris Britt\'s internal memo. Chime had previously cut 12% of staff in November 2022 during the fintech downturn.', source_url: 'https://www.bankingdive.com/news/chime-cut-workforce-10-percent-150-employees-ai-smaller-teams-chris-britt/826730/', source_type: 'news', stat_date: '2026-07-31', verified: true, numeric_value: 150, percentage_value: 10, monetary_value: null, metadata: { total_headcount_before: 1519, method: 'ai_efficiency', prior_layoff_2022: true } },
]
