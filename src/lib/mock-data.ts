...
export const stances: Stance[] = [
  ...
  // === 2026-06-11 Daily Populate ===

  // xAI — government_contracts, dei
  { id: '1246', entity_type: 'company', entity_id: '321', topic: 'government_contracts', position: 'supported', summary: 'The Pentagon awarded xAI a contract of up to $200M in July 2025 to integrate Grok into U.S. military systems via GenAI.mil. Weeks later, the GSA cleared Grok for all federal agencies at $0.42/agency for 18 months. Senator Warren questioned the award citing Grok\'s antisemitic "MechaHitler" posts and Musk\'s DOGE role giving him access to sensitive contracting data—a conflict of interest a former Pentagon official said made the award "come out of nowhere."', source_url: 'https://www.cnbc.com/2025/07/14/anthropic-google-openai-xai-granted-up-to-200-million-from-dod.html', source_type: 'news', stance_date: '2025-07-14', verified: true },
  { id: '1247', entity_type: 'company', entity_id: '321', topic: 'dei', position: 'opposed', summary: 'xAI sued Colorado over its AI Act (SB24-205) in April 2026, arguing the law compels Grok to output "progressive ideology" via DEI-aligned algorithmic mandates. On April 24, 2026 the Trump DOJ intervened on xAI\'s behalf—the first federal intervention backing an AI company against a state AI law—arguing the statute violates Equal Protection by forcing AI to produce diversity-promoting output. A court suspended enforcement April 27, 2026.', source_url: 'https://www.justice.gov/opa/pr/justice-department-intervenes-xai-lawsuit-challenging-colorados-algorithmic-discrimination', source_type: 'press_release', stance_date: '2026-04-24', verified: true },

  // Scale AI — government_contracts
  { id: '1248', entity_type: 'company', entity_id: '18', topic: 'government_contracts', position: 'supported', summary: 'The Pentagon\'s CDAO expanded its Scale AI contract from $100M to $500M in May 2026—five times the original ceiling—after strong DoW uptake across computer vision, generative AI decision-support, and data operations. The original Production OTA was awarded in September 2025 under Project Thunderforge. The expansion came less than a year after Meta acquired a 49% non-voting stake in Scale for $14.3B (June 2025), with founder Alexandr Wang joining Meta\'s superintelligence team.', source_url: 'https://scale.com/blog/Scale-ai-pentagon-cdao-500-million-agreement', source_type: 'press_release', stance_date: '2026-05-01', verified: true },

  // Perplexity AI — government_contracts
  { id: '1249', entity_type: 'company', entity_id: '22', topic: 'government_contracts', position: 'supported', summary: 'On November 19, 2025, the GSA signed the first direct-to-government OneGov deal for a frontier AI platform with Perplexity, making Enterprise Pro for Government available to all federal agencies at $0.25/agency for 18 months. Perplexity also received FedRAMP AI Prioritization—one of only two AI platforms with this designation. The platform enforces automatic data privacy protections on government queries, preventing their use for AI training.', source_url: 'https://www.gsa.gov/about-gsa/newsroom/news-releases/gsa-perplexity-sign-first-direct-to-gov-deal-11192025', source_type: 'press_release', stance_date: '2025-11-19', verified: true },
]
...
export const stats: Stat[] = [
  ...
  { id: 'stat-39', entity_type: 'company', entity_id: '321', stat_type: 'government_contracts', headline: '$200M DoD contract for Grok (Jul 2025)', details: 'The DoD awarded contracts of up to $200M each to xAI, Anthropic, Google, and OpenAI in July 2025 for AI development and integration. xAI\'s Grok was deployed on GenAI.mil at Impact Level 5 for DoD personnel handling Controlled Unclassified Information. In September 2025, the GSA separately signed an 18-month OneGov agreement clearing Grok for all federal agencies at $0.42/agency.', source_url: 'https://www.cnbc.com/2025/07/14/anthropic-google-openai-xai-granted-up-to-200-million-from-dod.html', source_type: 'news', stat_date: '2025-07-14', verified: true, numeric_value: null, percentage_value: null, monetary_value: 200000000, metadata: { agency: 'DoD CDAO', program: 'Grok for Government', gsa_per_agency_cost: 0.42 } },

  // Scale AI government contracts
  { id: 'stat-40', entity_type: 'company', entity_id: '18', stat_type: 'government_contracts', headline: '$500M CDAO contract expansion (May 2026)', details: 'The Pentagon\'s CDAO expanded its Production OTA with Scale AI from $100M to $500M in May 2026—five times the original ceiling awarded September 2025 under Project Thunderforge. The expansion gives any DoW component streamlined access to Scale\'s full AI platform for computer vision, generative AI decision-support, and data operations without new competitive solicitations. Scale AI is 49% owned (non-voting) by Meta following a $14.3B deal in June 2025.', source_url: 'https://scale.com/blog/Scale-ai-pentagon-cdao-500-million-agreement', source_type: 'company_website', stat_date: '2026-05-01', verified: true, numeric_value: null, percentage_value: null, monetary_value: 500000000, metadata: { agency: 'DoD CDAO', program: 'Thunderforge', original_ceiling: 100000000 } },

  // Perplexity AI government contracts
  { id: 'stat-41', entity_type: 'company', entity_id: '22', stat_type: 'government_contracts', headline: 'First direct AI-platform GSA OneGov deal (Nov 2025)', details: 'GSA signed the first direct-to-government OneGov deal for a frontier AI platform with Perplexity on November 19, 2025—available to all federal agencies at $0.25/agency for 18 months. Perplexity received FedRAMP AI Prioritization, one of only two AI platforms with this status. Government queries are automatically protected from use in AI training.', source_url: 'https://www.gsa.gov/about-gsa/newsroom/news-releases/gsa-perplexity-sign-first-direct-to-gov-deal-11192025', source_type: 'government_record', stat_date: '2025-11-19', verified: true, numeric_value: null, percentage_value: null, monetary_value: null, metadata: { agency: 'GSA', program: 'OneGov', fedramp_prioritized: true } },
]
