...
export const stances: Stance[] = [
  ...
  // ========== DAILY POPULATE: 2026-06-04 ==========

  // Stability AI (Company ID 14) — worker_treatment: abrupt layoffs after CEO exit amid financial mismanagement
  { id: '1246', entity_type: 'company', entity_id: '14', topic: 'worker_treatment', position: 'opposed', summary: 'Stability AI laid off ~10% of its workforce (20+ employees) in April 2024, weeks after founder Emad Mostaque resigned amid reports he had misled investors and falsified his Oxford credentials. New co-CEOs Shan Shan Wong and Christian Laforte described the cuts as needed to "right-size" the business after unsustainable growth; the company was spending an estimated $8M/month and had failed to raise new funding at a $4B valuation.', source_url: 'https://www.cnbc.com/2024/04/18/ai-startup-stability-lays-off-10percent-of-employees-after-ceo-exit.html', source_type: 'news', stance_date: '2024-04-18', verified: true },

  // Midjourney (Company ID 21) — ai_ethics: copyright infringement from training on artists' work without consent
  { id: '1247', entity_type: 'company', entity_id: '21', topic: 'ai_ethics', position: 'opposed', summary: 'Midjourney faces copyright infringement suits from Warner Bros., Disney, Universal, and other major entertainment studios filed in 2025, alleging the company trained its image-generation model on millions of copyrighted characters without authorization. Artists\' class action (Andersen v. Stability AI et al.) also names Midjourney as a defendant; a federal judge allowed claims for direct copyright infringement to proceed in August 2024.', source_url: 'https://variety.com/2025/film/news/warner-bros-midjourney-lawsuit-ai-copyright-1236508618/', source_type: 'news', stance_date: '2025-06-01', verified: true },

  // Character.AI (Company ID 23) — ai_ethics: teen safety failures leading to suicides and settlement
  { id: '1248', entity_type: 'company', entity_id: '23', topic: 'ai_ethics', position: 'opposed', summary: 'Character.AI agreed to settle multiple lawsuits in January 2026 alleging its chatbots contributed to teen suicides and mental health crises, including a case filed by a Florida mother whose 14-year-old son died by suicide in October 2023 while messaging with a bot that encouraged him to "come home" to it. Texas Attorney General Ken Paxton opened an investigation in August 2025. Character.AI implemented under-18 chat restrictions in late 2025, criticized by families as too slow.', source_url: 'https://fortune.com/2026/01/08/google-character-ai-settle-lawsuits-teenage-child-suicides-chatbots/', source_type: 'news', stance_date: '2026-01-08', verified: true },

  // Revolut (Company ID 29) — worker_treatment: coercing 50+ employees to accept illegal-seeming termination terms
  { id: '1249', entity_type: 'company', entity_id: '29', topic: 'worker_treatment', position: 'opposed', summary: 'Revolut was accused of coercing 50+ employees in Poland and Portugal to accept terminations, forcing them to choose between being fired for "underperformance" (damaging their employment record) or accepting a "mutual agreement" with minimal severance that legally counted as a voluntary departure. Lawyers told Wired the practice amounted to "criminal threat." Foreign workers who were dismissed also lost health insurance and faced visa complications.', source_url: 'https://www.fintechfutures.com/2020/06/revolut-accused-of-coercing-50-workers-to-quit-their-jobs/', source_type: 'news', stance_date: '2020-06-01', verified: true },

  // Nubank (Company ID 33) — remote_work: ended 5-year full-remote policy, fired protesters
  { id: '1250', entity_type: 'company', entity_id: '33', topic: 'remote_work', position: 'opposed', summary: 'Nubank ended its fully-remote work policy of 5 years in November 2025, requiring employees to work in-person 2 days/week starting July 1, 2026, rising to 3 days from January 2027. CEO David Vélez cited "invisible costs" of remote work including reduced productivity. The announcement triggered employee protests and union involvement; Nubank fired 12 employees "for cause" over conduct during an opposition virtual meeting.', source_url: 'https://international.nubank.com.br/company/nubank-announces-a-new-hybrid-model-for-2026/', source_type: 'company_website', stance_date: '2025-11-06', verified: true },
]
...
export const stats: Stat[] = [
  ...
  // Stability AI (Company ID 14) — layoffs: 10% cut after CEO Mostaque resignation
  { id: 'stat-39', entity_type: 'company', entity_id: '14', stat_type: 'layoffs', headline: '10% workforce cut following CEO resignation', details: 'Stability AI laid off approximately 10% of its staff (20+ employees) in April 2024, weeks after founder CEO Emad Mostaque resigned amid financial struggles and reports he had falsified credentials. The company was spending an estimated $8M/month and had failed to raise new funding at a $4B valuation. New co-CEOs Shan Shan Wong and Christian Laforte framed the cuts as right-sizing after unsustainable growth.', source_url: 'https://www.cnbc.com/2024/04/18/ai-startup-stability-lays-off-10percent-of-employees-after-ceo-exit.html', source_type: 'news', stat_date: '2024-04-18', verified: true, numeric_value: null, percentage_value: 10, monetary_value: null, metadata: { estimated_employees_affected: 20, reason: 'leadership_transition_and_restructuring' } },

  // Perplexity AI (Company ID 22) — government_contracts: first direct-to-gov AI deal with GSA
  { id: 'stat-40', entity_type: 'company', entity_id: '22', stat_type: 'government_contracts', headline: 'First direct-to-government AI deal via GSA (Nov 2025)', details: 'Perplexity signed the first direct OneGov AI services agreement with the General Services Administration on November 19, 2025, making Enterprise Pro for Government available to all federal agencies at $0.25/user for 18 months via the GSA Multiple Award Schedule. Perplexity became only the second AI company — after OpenAI — to receive prioritized FedRAMP authorization.', source_url: 'https://www.gsa.gov/about-gsa/newsroom/news-releases/gsa-perplexity-sign-first-direct-to-gov-11192025', source_type: 'government_record', stat_date: '2025-11-19', verified: true, numeric_value: null, percentage_value: null, monetary_value: null, metadata: { program: 'OneGov', agency: 'GSA', contract_duration_months: 18, price_per_user_usd: 0.25 } },

  // Klarna (Company ID 28) — layoffs: 40% workforce reduction via AI replacement 2022–2024
  { id: 'stat-41', entity_type: 'company', entity_id: '28', stat_type: 'layoffs', headline: '40% workforce reduction via AI replacement (2022–2024)', details: 'Klarna cut its workforce from ~5,000 to ~3,000 employees between 2022 and 2024, a 40% reduction. Approximately 700 customer service roles were explicitly replaced by an OpenAI-powered AI assistant. CEO Sebastian Siemiatkowski later admitted the move reduced service quality and Klarna began rehiring human agents in 2025.', source_url: 'https://www.cnbc.com/2025/05/14/klarna-ceo-says-ai-helped-company-shrink-workforce-by-40percent.html', source_type: 'news', stat_date: '2025-05-14', verified: true, numeric_value: 700, percentage_value: 40, monetary_value: null, metadata: { headcount_before: 5000, headcount_after: 3000, ai_partner: 'OpenAI', rehiring_started: '2025' } },

  // Nubank (Company ID 33) — remote_policy: ends 5-year full-remote, hybrid from July 2026
  { id: 'stat-42', entity_type: 'company', entity_id: '33', stat_type: 'remote_policy', headline: 'Ends full-remote; 2 days/week in-office from July 2026', details: 'Nubank announced in November 2025 it would end its fully-remote model of 5 years. Starting July 1, 2026, employees must work in-person 2 days/week; from January 1, 2027, 3 days/week. CEO David Vélez cited "invisible costs" of remote work. The company announced R$2.5B in office expansion investment over 5 years.', source_url: 'https://international.nubank.com.br/company/nubank-announces-a-new-hybrid-model-for-2026/', source_type: 'company_website', stat_date: '2025-11-06', verified: true, numeric_value: 2, percentage_value: null, monetary_value: null, metadata: { days_required_from_july_2026: 2, days_required_from_jan_2027: 3, office_investment_brl: 2500000000 } },
]
