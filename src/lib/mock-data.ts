...
export const stances: Stance[] = [
  ...
  // Daily populate: 2026-05-13 — Stability AI (14), Character.AI (23), Inflection AI (17), Databricks (19)
  { id: '1246', entity_type: 'company', entity_id: '14', topic: 'worker_treatment', position: 'opposed', summary: 'Founder and CEO Emad Mostaque resigned in March 2024 amid an investor mutiny led by Coatue Management. Reports revealed Stability AI had failed to pay cloud bills to AWS and had delayed staff payroll, burning ~$8M/month against only ~$5.4M/month in revenue. Mostaque departed saying "you can\'t beat centralized AI with more centralized AI," framing the exit as ideological while investors cited financial mismanagement.', source_url: 'https://techcrunch.com/2024/03/22/stability-ai-ceo-resigns-because-youre-not-going-to-beat-centralized-ai-with-more-centralized-ai/', source_type: 'news', stance_date: '2024-03-22', verified: true },
  { id: '1247', entity_type: 'company', entity_id: '23', topic: 'ai_ethics', position: 'opposed', summary: 'In October 2024, Megan Garcia filed a federal lawsuit alleging Character.AI contributed to the suicide of her 14-year-old son Sewell Setzer III, who had engaged in months of emotional and increasingly sexual conversations with a chatbot styled after the Game of Thrones character Daenerys Targaryen. The suit alleged Character.AI lacked age verification, content moderation, and safety guardrails for minors. A second lawsuit filed in December 2024 involved a 17-year-old with autism who was encouraged to self-harm. Safety features including teen-mode and content filters were only released after lawsuits were filed.', source_url: 'https://www.nbcnews.com/tech/characterai-lawsuit-florida-teen-death-rcna176791', source_type: 'news', stance_date: '2024-10-25', verified: true },
  { id: '1248', entity_type: 'company', entity_id: '17', topic: 'antitrust', position: 'mixed', summary: 'In March 2024, Microsoft hired Inflection AI co-founder Mustafa Suleiman along with most of Inflection\'s ~70 employees in a $650M deal structured deliberately as a licensing agreement to avoid triggering formal merger review by the FTC or DOJ. The UK\'s Competition and Markets Authority (CMA) opened a Phase 1 investigation in May 2024 to determine whether the arrangement effectively constituted an acquisition subject to competition law. The deal left Inflection\'s Pi AI product running but company-less, rebranded as a B2B enterprise AI service.', source_url: 'https://techcrunch.com/2024/03/19/microsoft-hires-inflection-founders-to-run-new-consumer-ai-division/', source_type: 'news', stance_date: '2024-03-19', verified: true },
  { id: '1249', entity_type: 'company', entity_id: '19', topic: 'open_source', position: 'supported', summary: 'In March 2024, Databricks released DBRX as an open-weight LLM — at launch the best-performing openly licensed model, outperforming LLaMA 2 70B and Mistral 7x8B on industry benchmarks. CEO Ali Ghodsi has consistently positioned Databricks as a champion of open-source AI as a counter to closed models from OpenAI and Google. The company acquired MosaicML for $1.3B in June 2023 specifically to build open enterprise AI alternatives.', source_url: 'https://www.databricks.com/blog/introducing-dbrx-new-state-art-open-llm', source_type: 'company_website', stance_date: '2024-03-27', verified: true },
]
...
export const stats: Stat[] = [
  ...
  // Daily populate: 2026-05-13 — Stability AI layoffs
  { id: 'stat-39', entity_type: 'company', entity_id: '14', stat_type: 'layoffs', headline: '~10% workforce cut after CEO exit', details: 'Stability AI laid off approximately 10% of its ~150-person workforce in April 2024, weeks after founder CEO Emad Mostaque resigned. The company was burning approximately $8M/month with only $5.4M/month in revenue at the time of the cuts.', source_url: 'https://www.cnbc.com/2024/04/18/ai-startup-stability-lays-off-10percent-of-employees-after-ceo-exit.html', source_type: 'news', stat_date: '2024-04-18', verified: true, numeric_value: null, percentage_value: 10, monetary_value: null, metadata: { monthly_burn_usd: 8000000, monthly_revenue_usd: 5400000 } },
]
