...
export const stances: Stance[] = [
  ...
  // Daily populate: 2026-05-28 — Character.AI, Stability AI, Klarna, Databricks, Perplexity AI
  { id: '1246', entity_type: 'company', entity_id: '23', topic: 'ai_ethics', position: 'opposed', summary: 'Multiple lawsuits filed in 2024 by families of teens who died by suicide after interacting with Character.AI chatbots, including Florida teen Sewell Setzer III. Bureau of Investigative Journalism found bots simulating paedophiles, extremists, and school shooters on the platform. In October 2025 Character.AI banned under-18s from chatting with its bots. Character.AI and Google agreed to settle the wrongful-death lawsuits in January 2026.', source_url: 'https://blog.character.ai/an-update-on-changes-to-our-under-18-experience/', source_type: 'company_website', stance_date: '2025-10-29', verified: true },
  { id: '1247', entity_type: 'company', entity_id: '14', topic: 'worker_treatment', position: 'opposed', summary: 'Stability AI\'s founding Stable Diffusion researchers resigned in 2023 citing lack of direction and resources. CEO Emad Mostaque stepped down in March 2024 after Forbes reported he misrepresented his Oxford degree and company metrics to investors. Weeks later the company laid off ~10% of staff (roughly 20 employees) while carrying nearly $100M in debt to cloud providers on less than $5M quarterly revenue.', source_url: 'https://www.theregister.com/2024/04/18/stability_ai_layoff_staff/', source_type: 'news', stance_date: '2024-04-18', verified: true },
  { id: '1248', entity_type: 'company', entity_id: '28', topic: 'worker_treatment', position: 'opposed', summary: 'In February 2024, Klarna announced its OpenAI-powered assistant was handling two-thirds of customer service chats — the equivalent of 700 full-time agents — as part of a hiring freeze that shrank headcount ~40% from ~5,000 to ~3,000. By 2025 CEO Siemiatkowski publicly admitted quality suffered and the company "went too far," and began rehiring human agents.', source_url: 'https://www.klarna.com/international/press/klarna-ai-assistant-handles-two-thirds-of-customer-service-chats-in-its-first-month/', source_type: 'press_release', stance_date: '2024-02-27', verified: true },
  { id: '1249', entity_type: 'company', entity_id: '19', topic: 'politics', position: 'mixed', summary: 'In March 2025, Databricks and Palantir announced a formal partnership to jointly pursue federal government efficiency contracts aligned with the Trump administration\'s DOGE initiative. Databricks Federal secured DoD CDAO and GSA schedule contracts in 2025. The platform is used by 400+ public sector entities, including for immigration-enforcement and national-security analytics.', source_url: 'https://www.axios.com/2025/03/13/databricks-palantir-trump-doge', source_type: 'news', stance_date: '2025-03-13', verified: true },
  { id: '1250', entity_type: 'company', entity_id: '22', topic: 'antitrust', position: 'opposed', summary: 'The New York Times sued Perplexity AI for copyright infringement in December 2025, alleging large-scale scraping of millions of articles via crawlers that intentionally bypassed robots.txt. News Corp, Encyclopedia Britannica, Merriam-Webster, Nikkei, and Asahi Shimbun filed parallel suits seeking hundreds of millions in damages. Perplexity launched a $42.5M publisher revenue-sharing program as partial mitigation but continued fighting the suits.', source_url: 'https://techcrunch.com/2025/12/05/the-new-york-times-is-suing-perplexity-for-copyright-infringement/', source_type: 'news', stance_date: '2025-12-05', verified: true },
]
...
export const stats: Stat[] = [
  ...
  // Daily populate: 2026-05-28 — Klarna AI layoffs, Stability AI layoffs, Databricks government contracts
  { id: 'stat-39', entity_type: 'company', entity_id: '28', stat_type: 'layoffs', headline: 'Workforce shrank ~40% via AI automation', details: 'Klarna\'s headcount fell from approximately 5,000 to ~3,000 employees between 2022 and 2025 — a ~40% reduction CEO Siemiatkowski attributed in part to AI replacing human roles. An OpenAI-powered assistant claimed to handle two-thirds of customer chats (equivalent to 700 agents). By mid-2025 the CEO acknowledged quality had suffered and the company resumed hiring.', source_url: 'https://www.cnbc.com/2025/05/14/klarna-ceo-says-ai-helped-company-shrink-workforce-by-40percent.html', source_type: 'news', stat_date: '2025-05-14', verified: true, numeric_value: 2000, percentage_value: 40, monetary_value: null, metadata: { headcount_before: 5000, headcount_after: 3000, ai_replaced_equivalent: 700 } },
  { id: 'stat-40', entity_type: 'company', entity_id: '14', stat_type: 'layoffs', headline: '~10% staff cut after CEO departure', details: 'Stability AI laid off roughly 10% of global headcount (~20 employees) in April 2024, weeks after founder Emad Mostaque resigned amid credential-fraud reports. The cuts targeted operational staff. The company carried nearly $100M in debt to cloud providers while posting losses exceeding $30M per quarter on under $5M revenue.', source_url: 'https://www.theregister.com/2024/04/18/stability_ai_layoff_staff/', source_type: 'news', stat_date: '2024-04-18', verified: true, numeric_value: 20, percentage_value: 10, monetary_value: null, metadata: { debt_owed: 100000000, quarterly_loss: 30000000 } },
  { id: 'stat-41', entity_type: 'company', entity_id: '19', stat_type: 'government_contracts', headline: 'DoD CDAO contract + Palantir DOGE partnership', details: 'The DoD\'s Chief Digital and Artificial Intelligence Office awarded Databricks a prototype AI analytics contract in 2025. In March 2025, Databricks and Palantir announced a formal partnership to jointly pursue federal government efficiency contracts under the Trump/DOGE agenda. Databricks is deployed by 400+ public sector entities for analytics, AI, and national-security workloads.', source_url: 'https://www.axios.com/2025/03/13/databricks-palantir-trump-doge', source_type: 'news', stat_date: '2025-03-13', verified: true, numeric_value: null, percentage_value: null, monetary_value: null, metadata: { agency: 'DoD CDAO', partner: 'Palantir', program: 'DOGE/Federal efficiency' } },
]
