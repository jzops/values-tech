...
export const stances: Stance[] = [
  ...
  // AI company open_source stances — 2026-05-27
  { id: '1246', entity_type: 'company', entity_id: '14', topic: 'open_source', position: 'mixed', summary: 'Stability AI released Stable Diffusion XL (SDXL) under an open RAIL license in 2023, enabling broad commercial use and bootstrapping the open-source image generation ecosystem. However, Stable Diffusion 3 (June 2024) shipped under the Stability AI Community License, which restricts commercial use and requires a paid enterprise agreement for production deployments — drawing widespread criticism that the company was retreating from the open ethos that made it famous. The generative-models GitHub repo remains public but model weights now carry tiered licensing.', source_url: 'https://github.com/Stability-AI/generative-models', source_type: 'company_website', stance_date: '2024-06-12', verified: true },
  { id: '1247', entity_type: 'company', entity_id: '19', topic: 'open_source', position: 'supported', summary: 'Databricks created and maintains MLflow, the industry-standard open-source ML experiment tracking framework (Apache 2.0), with 18M+ monthly downloads and 700+ contributors as of 2024. In April 2023 they open-sourced Dolly 2.0 — the first commercially permissive instruction-following LLM — under the Apache 2.0 license, including both model weights and training data. Their June 2023 acquisition of MosaicML for approximately $1.3B, creators of the open-source LLM Foundry training framework, further reinforced their open AI infrastructure strategy.', source_url: 'https://github.com/databricks/mlflow', source_type: 'company_website', stance_date: '2023-04-12', verified: true },
  { id: '1248', entity_type: 'company', entity_id: '21', topic: 'open_source', position: 'opposed', summary: 'Midjourney has never released model weights, training code, or dataset details since launching its AI image service in July 2022 and has no public repositories on GitHub. Unlike competitors Stability AI (which open-sourced Stable Diffusion) and Hugging Face (which distributes open models), Midjourney maintains an entirely proprietary pipeline, generating an estimated $200M+ in 2023 revenue without contributing code or data back to the open-source AI community it depends on for foundational research.', source_url: 'https://github.com/midjourney', source_type: 'company_website', stance_date: '2024-01-01', verified: true },
]
