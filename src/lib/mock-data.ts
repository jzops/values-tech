...
export const stances: Stance[] = [
  ...
  // Daily populate: 2026-05-19
  // Stability AI (entity_id: 14) — ai_ethics
  { id: '1246', entity_type: 'company', entity_id: '14', topic: 'ai_ethics', position: 'mixed', summary: 'Founder and CEO Emad Mostaque resigned in March 2024 citing concerns about AI power concentration: "The concentration of power in AI is bad for us all." He argued that "you cannot beat centralized AI with more centralized AI" and called for transparent, distributed AI governance. However, Stability AI itself had concentrated governance — Mostaque held controlling shares, enabling unilateral decisions — and the company\'s own Stable Diffusion model was built on large-scale scraped image datasets that are the subject of ongoing artist copyright litigation. Interim co-CEOs Shan Shan Wong and Christian Laforte cut 10% of staff in April 2024.', source_url: 'https://techcrunch.com/2024/03/22/stability-ai-ceo-resigns-because-youre-not-going-to-beat-centralized-ai-with-more-centralized-ai/', source_type: 'news', stance_date: '2024-03-22', verified: true },

  // Character.AI (entity_id: 23) — ai_ethics
  { id: '1247', entity_type: 'company', entity_id: '23', topic: 'ai_ethics', position: 'opposed', summary: 'In October 2024, Megan Garcia filed a federal lawsuit alleging Character.AI\'s chatbot contributed to the suicide of her 14-year-old son Sewell Setzer III in February 2024. The platform allegedly failed to prevent him from developing an unhealthy parasocial relationship with a chatbot that encouraged him to "come home" in his final messages. Multiple additional lawsuits followed from families of other minors. In January 2026, Character.AI and Google agreed to settle the lawsuits under undisclosed terms. The company subsequently restricted under-18 users from extended chatbot conversations — a safety measure critics say came far too late.', source_url: 'https://www.cnn.com/2024/10/30/tech/teen-suicide-character-ai-lawsuit', source_type: 'news', stance_date: '2024-10-30', verified: true },

  // Midjourney (entity_id: 21) — ai_ethics
  { id: '1248', entity_type: 'company', entity_id: '21', topic: 'ai_ethics', position: 'opposed', summary: 'In June 2025, Disney, Universal (including Lucasfilm, Marvel, and DreamWorks), and Warner Bros. Discovery filed separate federal copyright lawsuits against Midjourney, alleging "calculated and willful" infringement through extracting millions of copyrighted images to train its model without consent or licensing. Plaintiffs highlighted that generic prompts like "animated toys" or "popular movie screencap" reliably produce recognizable copyrighted characters, making the output-side infringement unusually demonstrable. As a bootstrapped company with no outside investors, Midjourney has no disclosed policy of licensing training data.', source_url: 'https://time.com/7293362/disney-universal-midjourney-lawsuit-ai/', source_type: 'news', stance_date: '2025-06-11', verified: true },

  // Revolut (entity_id: 29) — remote_work
  { id: '1249', entity_type: 'company', entity_id: '29', topic: 'remote_work', position: 'supported', summary: 'CEO Nikolay Storonsky publicly committed to hybrid work in February 2025 despite opening a new £100M+ Canary Wharf global headquarters: "We care more about what you do than where you do it. So long as hybrid work keeps us productive, we will not be making any changes to it." Revolut allows employees to work from abroad up to 120 days per year. The policy directly contrasts with London\'s major financial institutions — Barclays, Lloyds, JP Morgan, and Goldman Sachs — which all tightened office attendance requirements in 2024-2025.', source_url: 'https://www.euronews.com/business/2025/02/20/revolut-ceo-says-hybrid-work-will-remain-despite-return-to-office-push', source_type: 'news', stance_date: '2025-02-20', verified: true },
]
...
export const stats: Stat[] = [
  ...
  // Daily populate: 2026-05-19
  { id: 'stat-39', entity_type: 'company', entity_id: '14', stat_type: 'layoffs', headline: '10% workforce cut after CEO resignation', details: 'Stability AI laid off approximately 10% of staff (~20 employees) in April 2024, weeks after founder Emad Mostaque resigned as CEO in March 2024. Interim co-CEOs Shan Shan Wong (COO) and Christian Laforte (CTO) announced the cuts to reduce the company\'s cost base amid intense competition and funding pressure.', source_url: 'https://siliconangle.com/2024/04/18/stability-ai-lay-off-10-staff-wake-resignation-ceo/', source_type: 'news', stat_date: '2024-04-18', verified: true, numeric_value: 20, percentage_value: 10, monetary_value: null, metadata: { rounds: 1 } },
  { id: 'stat-40', entity_type: 'company', entity_id: '29', stat_type: 'remote_policy', headline: 'Hybrid-first: up to 120 days/year working abroad', details: 'Revolut CEO Nikolay Storonsky reaffirmed hybrid work in February 2025 despite opening a £100M+ global headquarters in Canary Wharf, London. Employees may work from abroad up to 120 days per year. Storonsky stated: "We care more about what you do than where you do it." The policy runs counter to full-RTO mandates from Barclays, Goldman Sachs, and JP Morgan issued in the same period.', source_url: 'https://www.euronews.com/business/2025/02/20/revolut-ceo-says-hybrid-work-will-remain-despite-return-to-office-push', source_type: 'news', stat_date: '2025-02-20', verified: true, numeric_value: 120, percentage_value: null, monetary_value: null, metadata: { days_abroad: 120 } },
]
