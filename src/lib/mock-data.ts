...
export const stances: Stance[] = [
  ...
  // — Daily populate 2026-05-04 —

  // xAI (Company ID 321) - environment, worker_treatment
  { id: '1246', entity_type: 'company', entity_id: '321', topic: 'environment', position: 'opposed', summary: 'xAI operated 35 methane-powered gas turbines at its South Memphis "Colossus" data center without proper air permits, emitting an estimated 1,200–2,000 tons of nitrogen oxides per year — likely making it the largest single industrial NOx emitter in Memphis. The Southern Environmental Law Center filed a notice of intent to sue and petitioned the EPA; the NAACP appealed permits granted retroactively by the Shelby County Health Department in 2025.', source_url: 'https://www.cnbc.com/2025/04/10/elon-musks-xai-accused-polluting-air-in-memphis-selc-says-in-letter.html', source_type: 'news', stance_date: '2025-04-10', verified: true },
  { id: '1247', entity_type: 'company', entity_id: '321', topic: 'worker_treatment', position: 'opposed', summary: 'On September 12, 2025, xAI laid off approximately 500 data-annotation workers — roughly one-third of its 1,500-person AI-tutor team — who had been training the Grok AI model. Workers were notified by email with system access cut off immediately; the company said it would replace broad "general AI tutor roles" with narrower STEM specialists and planned to "surge" specialist hiring by 10x.', source_url: 'https://techcrunch.com/2025/09/13/xai-reportedly-lays-off-500-workers-from-data-annotation-team/', source_type: 'news', stance_date: '2025-09-12', verified: true },

  // Character.AI (Company ID 23) - ai_ethics
  { id: '1248', entity_type: 'company', entity_id: '23', topic: 'ai_ethics', position: 'opposed', summary: 'In October 2024, Megan Garcia filed a federal lawsuit alleging Character.AI\'s chatbot contributed to the February 2024 suicide of her 14-year-old son Sewell Setzer III, who had developed a romantic relationship with a Game of Thrones-character bot without adequate safety guardrails. By January 2026, Google and Character.AI agreed to settle multiple teen-harm lawsuits. The FTC and Texas Attorney General opened separate investigations, and Character.AI introduced an under-18 chat restriction in late 2025 — criticized as too late.', source_url: 'https://www.cnn.com/2024/10/30/tech/teen-suicide-character-ai-lawsuit', source_type: 'news', stance_date: '2024-10-30', verified: true },

  // Scale AI (Company ID 18) - contractor_classification (2024-2025 lawsuits update)
  { id: '1249', entity_type: 'company', entity_id: '18', topic: 'contractor_classification', position: 'opposed', summary: 'Between December 2024 and January 2025, Scale AI faced at least two California class-action lawsuits alleging it misclassified data-labeling "Taskers" as contractors, paid them for only half their actual hours, and required invasive keylogger surveillance software as a condition of work. The U.S. Department of Labor opened a Fair Labor Standards Act investigation in March 2025. Scale AI agreed to settle four California lawsuits later in 2025.', source_url: 'https://techcrunch.com/2025/03/06/scale-ai-is-being-investigated-by-the-us-department-of-labor/', source_type: 'news', stance_date: '2025-03-06', verified: true },

  // Perplexity AI (Company ID 22) - data_privacy (NYT + publisher lawsuit wave 2025)
  { id: '1250', entity_type: 'company', entity_id: '22', topic: 'data_privacy', position: 'opposed', summary: 'By December 2025, Perplexity faced 20+ publisher copyright lawsuits including from The New York Times, Chicago Tribune, Nikkei, Asahi Shimbun, Encyclopedia Britannica, and Reddit. The NYT complaint detailed Perplexity\'s "PerplexityBot" ignoring the paper\'s hard-block robots.txt directive, and its Comet browser bypassing paywalls to generate full article summaries — reproducing journalism verbatim to answer queries without attribution or payment.', source_url: 'https://techcrunch.com/2025/12/05/the-new-york-times-is-suing-perplexity-for-copyright-infringement/', source_type: 'news', stance_date: '2025-12-05', verified: true },
]
...
export const stats: Stat[] = [
  ...
  // Databricks (Company ID 19) - government_contracts
  { id: 'stat-39', entity_type: 'company', entity_id: '19', stat_type: 'government_contracts', headline: '$17M DoD CDAO AI contract + IL5 authorization', details: 'The DoD Chief Digital and AI Officer (CDAO) awarded Databricks a $17M Other Transaction Authority prototype contract in 2024 to fast-track AI deployment across the Defense enterprise. Databricks also received DoD Impact Level 5 (IL5) Provisional Authorization in November 2024 — enabling DoD agencies and intelligence community partners to process classified and Controlled Unclassified Information (CUI) on its Data Intelligence Platform via AWS GovCloud.', source_url: 'https://www.databricks.com/company/newsroom/press-releases/databricks-achieves-authorization-dod-il5-aws-govcloud', source_type: 'company_website', stat_date: '2024-11-15', verified: true, numeric_value: null, percentage_value: null, monetary_value: 17000000, metadata: { agency: 'DoD CDAO', program: 'OTA AI prototype + IL5 auth', classification: 'IL5' } },
]
