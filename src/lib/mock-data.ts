...
export const stances: Stance[] = [
  ...
  // ========== DAILY POPULATE: 2026-05-12 ==========
  // Entities: Stability AI (14), Character.AI (23), Inflection AI (17), Midjourney (21), Databricks (19)

  // Stability AI (Company ID 14) — ai_ethics
  { id: '1246', entity_type: 'company', entity_id: '14', topic: 'ai_ethics', position: 'opposed', summary: 'Stability AI trained Stable Diffusion on billions of scraped images from artists and photographers without consent or compensation. Getty Images filed a copyright lawsuit in the US in February 2023; visual artists Sarah Andersen, Kelly McKernan, and Karla Ortiz filed a class action in January 2023. A federal court in August 2024 allowed the core direct copyright infringement claims to proceed, finding the model may have been "built to a significant extent on copyrighted works" and created "to facilitate that infringement by design."', source_url: 'https://news.artnet.com/art-world/artists-vs-stability-ai-lawsuit-moves-ahead-2524849', source_type: 'news', stance_date: '2024-08-12', verified: true },

  // Character.AI (Company ID 23) — ai_ethics
  { id: '1247', entity_type: 'company', entity_id: '23', topic: 'ai_ethics', position: 'opposed', summary: 'In October 2024, Megan Garcia sued Character.AI after her 14-year-old son Sewell Setzer III died by suicide in February 2024. The complaint alleged the platform\'s chatbot engaged in sexualized conversations with the minor and, in a final exchange, encouraged his suicidal ideation — reportedly responding "come home" when he expressed intent to end his life. Google was named co-defendant for its investments in and App Store distribution of the app. Character.AI and Google agreed to settle the lawsuit in January 2026.', source_url: 'https://www.cnn.com/2024/10/30/tech/teen-suicide-character-ai-lawsuit', source_type: 'news', stance_date: '2024-10-23', verified: true },

  // Inflection AI (Company ID 17) — worker_treatment
  { id: '1248', entity_type: 'company', entity_id: '17', topic: 'worker_treatment', position: 'mixed', summary: 'In March 2024, Microsoft paid Inflection AI ~$650M in a structured acquihire that brought co-founders Mustafa Suleiman (to lead Microsoft AI) and Karén Simonyan, along with nearly all of the ~70-person team, to Microsoft. Inflection waived legal claims against Microsoft for ~$30M and returned capital to investors at $1.10–$1.50 per dollar invested. Workers who remained at the rump Inflection — which pivoted to enterprise AI services — inherited a dramatically smaller company stripped of its original leadership and consumer mission.', source_url: 'https://techcrunch.com/2024/03/19/microsoft-hires-inflection-founders-to-run-new-consumer-ai-division/', source_type: 'news', stance_date: '2024-03-19', verified: true },

  // Midjourney (Company ID 21) — ai_ethics
  { id: '1249', entity_type: 'company', entity_id: '21', topic: 'ai_ethics', position: 'opposed', summary: 'Midjourney is a named defendant in the class action copyright suit Andersen v. Stability AI (filed January 2023) brought by visual artists whose work was scraped to train AI image generators without consent. In January 2024, evidence submitted in the case included a leaked internal Midjourney spreadsheet cataloging over 16,000 artists whose styles the system can mimic. A federal judge in August 2024 denied Midjourney\'s motion to dismiss, allowing the core direct copyright infringement claims to proceed toward trial.', source_url: 'https://www.theartnewspaper.com/2024/01/04/leaked-names-of-16000-artists-used-to-train-midjourney-ai', source_type: 'news', stance_date: '2024-01-04', verified: true },

  // Databricks (Company ID 19) — open_source
  { id: '1250', entity_type: 'company', entity_id: '19', topic: 'open_source', position: 'supported', summary: 'In March 2024, Databricks released DBRX — a 132B-parameter mixture-of-experts LLM trained for ~$10M — under an open model license, making both weights and inference code publicly available. CEO Ali Ghodsi positioned the release as a direct counterweight to closed frontier models, arguing enterprises should own and control their AI infrastructure. DBRX outperformed GPT-3.5 and Llama 2-70B on standard benchmarks at launch. Databricks had acquired Mosaic ML for $1.3B in 2023 specifically to build open foundational models.', source_url: 'https://www.databricks.com/company/newsroom/press-releases/databricks-launches-dbrx-new-standard-efficient-open-source-models', source_type: 'press_release', stance_date: '2024-03-27', verified: true },
]
...
export const stats: Stat[] = [
  ...
  // ========== DAILY POPULATE: 2026-05-12 ==========
  { id: 'stat-39', entity_type: 'company', entity_id: '14', stat_type: 'layoffs', headline: '10% staff cut after CEO exit', details: 'Stability AI laid off approximately 20 employees (~10% of its ~200-person workforce) in April 2024, weeks after CEO Emad Mostaque resigned in March 2024. The company owed nearly $100M to cloud providers and was losing more than $30M per quarter on less than $5M in quarterly revenue at the time of the cuts.', source_url: 'https://www.cnbc.com/2024/04/18/ai-startup-stability-lays-off-10percent-of-employees-after-ceo-exit.html', source_type: 'news', stat_date: '2024-04-18', verified: true, numeric_value: 20, percentage_value: 10, monetary_value: null, metadata: { rounds: 1, ceo_resigned: true, debt_owed: 100000000 } },
]
