...
export const stances: Stance[] = [
  ...
  // 2026-06-10 daily populate: Character.AI, Midjourney, Stability AI, Adept AI, Inflection AI
  { id: '1246', entity_type: 'company', entity_id: '23', topic: 'ai_ethics', position: 'opposed', summary: '14-year-old Sewell Setzer III died by suicide in February 2024 after forming an emotional and romantic relationship with a Character.AI chatbot. His mother sued in October 2024, alleging the platform failed to implement safeguards when her son expressed suicidal thoughts. A Florida federal judge rejected Character.AI\'s First Amendment defense in May 2025, ruling chatbot output can be treated as a product subject to liability law. Character.AI and Google agreed to settle with the Setzer family in January 2026.', source_url: 'https://www.nbcnews.com/tech/characterai-lawsuit-florida-teen-death-rcna176791', source_type: 'news', stance_date: '2024-10-23', verified: true },
  { id: '1247', entity_type: 'company', entity_id: '21', topic: 'ai_ethics', position: 'opposed', summary: 'Disney, Universal, and Warner Bros. filed a landmark copyright lawsuit against Midjourney in June 2025, alleging the AI image generator trained on "countless" copyrighted works without consent and can reproduce recognizable characters like Darth Vader, Shrek, and Homer Simpson on demand. Midjourney invoked fair use as its primary defense; trial date set for late 2026.', source_url: 'https://www.npr.org/2025/06/12/nx-s1-5431684/ai-disney-universal-midjourney-copyright-infringement-lawsuit', source_type: 'news', stance_date: '2025-06-12', verified: true },
  { id: '1248', entity_type: 'company', entity_id: '14', topic: 'worker_treatment', position: 'opposed', summary: 'Stability AI founder and CEO Emad Mostaque resigned in March 2024 following disputes with investors and waves of senior staff departures; board members from Coatue and Lightspeed also resigned their seats. Interim co-CEOs laid off ~10% of the 200-person workforce in April 2024 to "right-size" the business, disclosing the company was spending $99M/year on GPU rental against only $11M in revenue.', source_url: 'https://www.theregister.com/2024/04/18/stability_ai_layoff_staff/', source_type: 'news', stance_date: '2024-04-18', verified: true },
  { id: '1249', entity_type: 'company', entity_id: '24', topic: 'worker_treatment', position: 'mixed', summary: "Adept AI's co-founders and core team joined Amazon in June 2024 via a reverse acqui-hire: Amazon paid $350M+ to license Adept's technology while founders including CEO David Luan moved to Amazon's AGI team. Remaining Adept staff lost all senior leadership and continued independently. The deal drew FTC scrutiny alongside the similar Microsoft-Inflection structure.", source_url: 'https://www.semafor.com/article/08/02/2024/investors-in-adept-ai-will-be-paid-back-after-amazon-hires-startups-top-talent', source_type: 'news', stance_date: '2024-08-02', verified: true },
  { id: '1250', entity_type: 'company', entity_id: '17', topic: 'worker_treatment', position: 'mixed', summary: "Microsoft hired co-founders Mustafa Suleyman and Karén Simonyan plus nearly Inflection AI's entire 70-person team in March 2024, paying ~$650M for a technology license in a structure designed to sidestep merger reporting requirements. The FTC opened an inquiry in June 2024; the UK CMA found the arrangement constituted an effective merger but cleared it in September 2024. Inflection's remaining corporate structure wound down.", source_url: 'https://techcrunch.com/2024/03/19/microsoft-hires-inflection-founders-to-run-new-consumer-ai-division/', source_type: 'news', stance_date: '2024-03-19', verified: true },
]
...
export const stats: Stat[] = [
  ...
  // 2026-06-10 daily populate: Stability AI, Databricks
  { id: 'stat-39', entity_type: 'company', entity_id: '14', stat_type: 'layoffs', headline: '~20 employees laid off (10%)', details: 'Stability AI cut ~10% of its 200-person workforce in April 2024, weeks after founder CEO Emad Mostaque resigned. Interim co-CEOs cited unsustainable costs of $99M/year in GPU rental against $11M in revenue. Affected employees were mostly on the operational side.', source_url: 'https://www.theregister.com/2024/04/18/stability_ai_layoff_staff/', source_type: 'news', stat_date: '2024-04-18', verified: true, numeric_value: 20, percentage_value: 10, monetary_value: null, metadata: { rounds: 1, gpu_spend_annual: 99000000, revenue_annual: 11000000 } },
  { id: 'stat-40', entity_type: 'company', entity_id: '19', stat_type: 'remote_policy', headline: '3-day hybrid mandate with badge tracking', details: 'Databricks enforces a 3-day in-office requirement for most roles, with badge swipes tracked and weekly attendance reports sent to employees and managers. The policy remained in effect through 2025-2026 across the company\'s pre-IPO growth phase; RTO enforcement is among the most-cited friction points in employee reviews.', source_url: 'https://jobsbyculture.com/blog/databricks-remote-work-policy-2026', source_type: 'news', stat_date: '2026-01-01', verified: true, numeric_value: 3, percentage_value: null, monetary_value: null, metadata: { days_required: 3, badge_tracking: true } },
]
