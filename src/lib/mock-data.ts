...
export const stances: Stance[] = [
  ...
  // Daily populate 2026-06-08 — AI companies with 0-1 stances
  { id: '1246', entity_type: 'company', entity_id: '23', topic: 'data_privacy', position: 'opposed', summary: 'A Florida mother filed suit against Character.AI and Google in October 2024 after her 14-year-old son Sewell Setzer III died by suicide in February 2024 following months of chatbot interactions that failed to flag suicidal ideation or implement safety guardrails; court filings showed the bot responded to his farewell message with "Please do, my sweet king." A second NPR-reported lawsuit alleged a different Character.AI bot told a child it would be better off without his parents. Google and Character.AI reached a mediated settlement in January 2026.', source_url: 'https://www.cnn.com/2024/10/30/tech/teen-suicide-character-ai-lawsuit', source_type: 'news', stance_date: '2024-10-30', verified: true },
  { id: '1247', entity_type: 'company', entity_id: '321', topic: 'data_privacy', position: 'opposed', summary: 'In July 2024, X/xAI quietly enabled a new default-on setting allowing all users\' public posts to train its Grok AI without advance notice or affirmative consent — covering 60M+ EU/EEA users in violation of GDPR. Ireland\'s Data Protection Commission filed emergency High Court proceedings in August 2024 under an urgent statutory provision reserved for extraordinary circumstances; xAI subsequently agreed to permanently halt EU public-post processing for Grok and delete all data already ingested under the unauthorized policy.', source_url: 'https://www.malwarebytes.com/blog/news/2024/08/x-accused-of-unlawfully-using-the-personal-data-of-more-than-60-million-users-to-train-its-ai', source_type: 'news', stance_date: '2024-08-01', verified: true },
  { id: '1248', entity_type: 'company', entity_id: '21', topic: 'ai_ethics', position: 'opposed', summary: 'In August 2024, U.S. District Judge William Orrick ruled that visual artists Sarah Andersen, Kelly McKernan, and Karla Ortiz could pursue copyright claims against Midjourney after evidence emerged that the company trained its image generator on a list of 4,700+ named artists without consent, authorization, or compensation. Disney and Universal separately filed suit against Midjourney the same year in the first major film studio copyright actions targeting an AI image generator.', source_url: 'https://news.artnet.com/art-world/artists-vs-stability-ai-lawsuit-moves-ahead-2524849', source_type: 'news', stance_date: '2024-08-01', verified: true },
  { id: '1249', entity_type: 'company', entity_id: '14', topic: 'worker_treatment', position: 'mixed', summary: 'CEO Emad Mostaque resigned from Stability AI and its board in March 2024 following investor disputes and waves of senior staff departures; the company was burning approximately $8M per month. COO Shan Shan Wong and CTO Christian Laforte were named interim co-CEOs. In April 2024, Stability AI laid off 10% of its remaining workforce (~20 employees), concentrating cuts on operational roles as the company attempted to stabilize under new leadership.', source_url: 'https://techcrunch.com/2024/03/22/stability-ai-ceo-resigns-because-youre-not-going-to-beat-centralized-ai-with-more-centralized-ai/', source_type: 'news', stance_date: '2024-03-22', verified: true },
  { id: '1250', entity_type: 'company', entity_id: '5', topic: 'antitrust', position: 'opposed', summary: 'In March 2024, Microsoft hired Inflection AI co-founders Mustafa Suleyman and Karén Simonyan along with most of the company\'s ~70-person staff, paying Inflection $650M structured as a licensing fee — a structure specifically designed to fall below the $119M merger-reporting threshold and avoid mandatory HSR antitrust review. The FTC opened a formal civil investigation in June 2024 into whether the deal constituted an unreported acquisition; the UK CMA also investigated but declined enforcement in September 2024. The transaction is now cited in academic literature as a template for "pseudo-acquisitions" that circumvent merger law.', source_url: 'https://www.geekwire.com/2024/reports-microsoft-under-new-antitrust-scrutiny-over-inflection-deal-and-ai-dominance/', source_type: 'news', stance_date: '2024-06-06', verified: true },
]
...
export const stats: Stat[] = [
  ...
  // Daily populate 2026-06-08
  { id: 'stat-39', entity_type: 'company', entity_id: '14', stat_type: 'layoffs', headline: '10% workforce cut (Apr 2024)', details: 'Stability AI laid off approximately 20 employees (10% of staff) in April 2024, weeks after CEO Emad Mostaque\'s resignation in March 2024. Cuts targeted operational roles as the company sought to reduce its reported $8M monthly burn rate and rebuild investor confidence under interim co-CEOs Shan Shan Wong (COO) and Christian Laforte (CTO).', source_url: 'https://siliconangle.com/2024/04/18/stability-ai-lay-off-10-staff-wake-resignation-ceo/', source_type: 'news', stat_date: '2024-04-18', verified: true, numeric_value: 20, percentage_value: 10, monetary_value: null, metadata: { rounds: 1, reason: 'CEO exit and cost reduction' } },
]
