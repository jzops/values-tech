...
export const stances: Stance[] = [
  ...
  // Daily populate: 2026-06-02 — Stability AI, Midjourney, Inflection AI, Perplexity AI
  // Stability AI (Company ID 14) — ai_ethics
  { id: '1246', entity_type: 'company', entity_id: '14', topic: 'ai_ethics', position: 'opposed', summary: 'A federal judge allowed artists\' class action copyright claims to proceed against Stability AI in August 2024, ruling core infringement claims were viable. Getty Images is separately suing Stability AI for up to $1.7 billion, alleging Stable Diffusion was trained on over 11,000 copyrighted images without consent. Founder Emad Mostaque resigned in March 2024 amid investor mutiny and waves of senior staff departures tied in part to copyright concerns.', source_url: 'https://techcrunch.com/2024/08/12/artists-lawsuit-against-generative-ai-makers-can-go-forward-judge-says/', source_type: 'news', stance_date: '2024-08-12', verified: true },

  // Midjourney (Company ID 21) — ai_ethics
  { id: '1247', entity_type: 'company', entity_id: '21', topic: 'ai_ethics', position: 'opposed', summary: 'Disney and Universal filed a 110-page copyright lawsuit against Midjourney on June 11, 2025, accusing it of operating a "virtual vending machine" producing unauthorized copies of Darth Vader, Shrek, Homer Simpson, and other protected characters. Warner Bros. joined the suit in summer 2025, making it the first major Hollywood coalition AI copyright case. Midjourney\'s August 2025 response argued fair use, noting Disney and Universal themselves profit from Midjourney tools.', source_url: 'https://www.npr.org/2025/06/12/nx-s1-5431684/ai-disney-universal-midjourney-copyright-infringement-lawsuit', source_type: 'news', stance_date: '2025-06-11', verified: true },

  // Inflection AI (Company ID 17) — antitrust
  { id: '1248', entity_type: 'company', entity_id: '17', topic: 'antitrust', position: 'mixed', summary: 'Microsoft paid Inflection AI $650 million in March 2024 — structured as a $620M technology license plus $30M to waive legal rights — and hired nearly all 70 staff including co-founders Mustafa Suleyman and Karén Simonyan. The FTC formally opened an investigation in June 2024 and the UK CMA launched a merger inquiry, with critics labeling it a "pseudo-acquisition" designed to evade antitrust review. The CMA closed its probe in September 2024 after finding no substantial lessening of competition.', source_url: 'https://www.deeplearning.ai/the-batch/microsoft-pays-inflection-ai-650-million-hires-most-of-its-staff', source_type: 'news', stance_date: '2024-03-21', verified: true },

  // Perplexity AI (Company ID 22) — data_privacy (escalation from June 2024)
  { id: '1249', entity_type: 'company', entity_id: '22', topic: 'data_privacy', position: 'opposed', summary: 'The New York Times sued Perplexity AI in December 2025 for circumventing a "hard-block" technical measure and ignoring robots.txt, with output reproducing Times content identically or substantially similarly. CNN filed a parallel lawsuit in May 2026 alleging Perplexity used thousands of CNN articles, videos, and images without permission. By May 2026, Perplexity faced back-to-back suits from the Times, CNN, Nikkei, Asahi Shimbun, Encyclopedia Britannica, and Merriam-Webster — all alleging the same two-stage infringement pattern.', source_url: 'https://ipwatchdog.com/2025/12/08/new-york-times-sues-perplexity-ai-latest-ip-case-genai-companies/', source_type: 'news', stance_date: '2025-12-08', verified: true },
]
...
export const stats: Stat[] = [
  ...
  // Daily populate: 2026-06-02 — Stability AI layoffs, Mistral AI defense contract
  // Stability AI (Company ID 14) — layoffs
  { id: 'stat-39', entity_type: 'company', entity_id: '14', stat_type: 'layoffs', headline: '10% staff cut after CEO departure', details: 'Stability AI laid off approximately 10% of its staff (~20 employees) in April 2024, weeks after founder Emad Mostaque resigned in March 2024. Interim co-CEOs Shan Shan Wong and Christian Laforte communicated the cuts, which primarily affected operational roles. The company had been burning ~$8M/month as of October 2023 while failing to close a new funding round at its $4B target valuation.', source_url: 'https://www.theregister.com/2024/04/18/stability_ai_layoff_staff/', source_type: 'news', stat_date: '2024-04-18', verified: true, numeric_value: 20, percentage_value: 10, monetary_value: null, metadata: { interim_ceos: ['Shan Shan Wong', 'Christian Laforte'], departing_ceo: 'Emad Mostaque' } },

  // Mistral AI (Company ID 16) — government_contracts
  { id: 'stat-40', entity_type: 'company', entity_id: '16', stat_type: 'government_contracts', headline: 'French Ministry of Defense framework agreement', details: 'Mistral AI signed a framework agreement with France\'s Ministry of the Armed Forces in January 2026, enabling Mistral models and services to be deployed across French armed forces, internal directorates, and affiliated public entities including the Atomic Energy Commission (CEA) and ONERA. The agreement is overseen by AMIAD (Ministry Agency for Defense Artificial Intelligence) and operates exclusively on French-sovereign infrastructure. Defense accounts for 10–15% of Mistral\'s revenue.', source_url: 'https://thedefensepost.com/2026/01/15/mistral-ai-france-defense/', source_type: 'news', stat_date: '2026-01-15', verified: true, numeric_value: null, percentage_value: null, monetary_value: null, metadata: { agency: 'French Ministry of Armed Forces', program: 'AMIAD' } },
]
