...
export const stances: Stance[] = [
  ...
  // === 2026-08-05 daily populate: Perplexity AI, Nubank, Affirm ===

  // Perplexity AI (Company ID 22) - worker_treatment
  { id: '1258', entity_type: 'company', entity_id: '22', topic: 'worker_treatment', position: 'opposed', summary: 'CEO Aravind Srinivas appeared on the All-In Podcast on March 30, 2026 and described AI-driven job displacement as a "glorious future" because "most people don\'t enjoy their jobs" and should pivot to entrepreneurship—drawing widespread criticism for dismissing the economic hardship caused by mass AI layoffs affecting over 101,000 US workers since early 2025.', source_url: 'https://fortune.com/2026/03/24/perplexity-ceo-ai-layoffs-not-bad-people-hate-jobs-entrepreneurship/', source_type: 'interview', stance_date: '2026-03-30', verified: true },

  // Nubank (Company ID 33) - worker_treatment
  { id: '1259', entity_type: 'company', entity_id: '33', topic: 'worker_treatment', position: 'opposed', summary: 'Following Nubank\'s November 2025 hybrid-work mandate, 12 employees were dismissed "for cause" after voicing opposition at an internal meeting with CEO David Vélez. Nubank claimed terminations were linked to "inappropriate behaviour" and alleged two employees planned to "sabotage internal systems." The São Paulo banking workers union called the dismissals retaliatory and demanded immediate reinstatement.', source_url: 'https://www.intellinews.com/brazil-s-nubank-fires-staff-over-alleged-sabotage-plot-410906/', source_type: 'news', stance_date: '2025-11-15', verified: true },

  // Affirm (Company ID 38) - worker_treatment
  { id: '1260', entity_type: 'company', entity_id: '38', topic: 'worker_treatment', position: 'supported', summary: 'CEO Max Levchin publicly pledged "We are not planning AI-related layoffs, full stop" on Affirm\'s May 8, 2026 earnings call, and mocked industry peers on a Yahoo Finance podcast for using AI as "the world\'s best fig leaf" to mask hiring mistakes. Levchin said Affirm\'s revenue-per-employee is "hanging out in Nvidia territory" — proof that AI augments rather than replaces workers.', source_url: 'https://finance.yahoo.com/markets/article/affirm-ceo-max-levchin-on-leaders-blaming-firings-on-ai-own-your-bad-decisions-143352010.html', source_type: 'interview', stance_date: '2026-05-08', verified: true },
]
...
export const stats: Stat[] = [
  ...
  // === 2026-08-05 daily populate: Chime, Nubank ===

  // Chime (Company ID 30) - layoffs
  { id: 'stat-46', entity_type: 'company', entity_id: '30', stat_type: 'layoffs', headline: '~150 employees (10% of workforce) cut citing AI efficiency gains', details: 'Chime Financial cut approximately 150 employees — around 10% of its ~1,500-person staff — on July 31, 2026. CEO Chris Britt\'s internal memo stated "AI is changing what\'s possible but requires new skills" and called for "a flatter structure and smaller squads." The restructuring came one year after Chime\'s June 2025 IPO and its first GAAP-profitable quarter (Q1 2026: $53M net income on $647M revenue, up 25% YoY, 90% gross margin).', source_url: 'https://www.pymnts.com/news/banking/2026/chime-cuts-10percent-of-workforce-in-ai-pivot/', source_type: 'news', stat_date: '2026-07-31', verified: true, numeric_value: 150, percentage_value: 10, monetary_value: null, metadata: { ceo: 'Chris Britt', ipo_year: 2025, q1_2026_net_income_usd: 53000000 } },

  // Nubank (Company ID 33) - remote_policy
  { id: 'stat-47', entity_type: 'company', entity_id: '33', stat_type: 'remote_policy', headline: 'Ends 5 years of remote-first: 2 in-office days/week from July 2026, rising to 3 in 2027', details: 'Nubank announced November 6, 2025 that after five years as a remote-first company, employees must work in-person 2 days per week starting July 2026, increasing to 3 days from January 2027. CEO David Vélez cited the need for deeper collaboration as the company scaled past 122 million customers across Latin America. Offices are being expanded in São Paulo, Mexico City, Bogotá, and several other cities. The policy triggered a union dispute after 12 employees who voiced opposition at an internal meeting were terminated.', source_url: 'https://building.nubank.com/nu-hybrid-work-model/', source_type: 'company_website', stat_date: '2025-11-06', verified: true, numeric_value: 2, percentage_value: null, monetary_value: null, metadata: { mandatory_office_days_jul_2026: 2, mandatory_office_days_jan_2027: 3, remote_years: 5, customers_millions: 122 } },
]
