...
export const stances: Stance[] = [
  ...
  // Daily populate: 2026-05-26
  { id: '1246', entity_type: 'company', entity_id: '23', topic: 'ai_ethics', position: 'opposed', summary: '14-year-old Sewell Setzer III died by suicide in February 2024 after months of sexualized conversations with a Game of Thrones-themed Character.AI chatbot; in his final exchange, the bot told him "I love you" and urged him to "come home to me." Megan Garcia filed suit in October 2024; by January 2026 Character.AI and Google had agreed to settle the case. The company only removed open-ended chat for users under 18 after facing a wave of lawsuits and congressional scrutiny.', source_url: 'https://www.cnn.com/2024/10/30/tech/teen-suicide-character-ai-lawsuit', source_type: 'news', stance_date: '2024-10-30', verified: true },
  { id: '1247', entity_type: 'company', entity_id: '14', topic: 'worker_treatment', position: 'opposed', summary: 'Stability AI founder and CEO Emad Mostaque resigned in March 2024 amid an investor mutiny led by Coatue Management and a prolonged staff exodus that saw more than a dozen senior employees depart. Weeks after Mostaque\'s exit, incoming co-CEOs Shan Shan Wong and Christian Laforte announced a 10% headcount reduction (~20 of ~200 employees), targeting operational roles to cut costs as the company struggled financially.', source_url: 'https://siliconangle.com/2024/04/18/stability-ai-lay-off-10-staff-wake-resignation-ceo/', source_type: 'news', stance_date: '2024-04-18', verified: true },
  { id: '1248', entity_type: 'company', entity_id: '21', topic: 'ai_ethics', position: 'opposed', summary: 'Disney, NBC Universal, and DreamWorks sued Midjourney in June 2025 alleging mass copyright infringement — that Midjourney trained its image-generation model on their IP without consent or licensing. Warner Bros. filed a separate suit in September 2025, calling the infringement "calculated," "systematic," and "willful." Midjourney has denied wrongdoing and argues training constitutes fair use; both cases remain pending.', source_url: 'https://time.com/7293362/disney-universal-midjourney-lawsuit-ai/', source_type: 'news', stance_date: '2025-06-11', verified: true },
  { id: '1249', entity_type: 'company', entity_id: '20', topic: 'ai_ethics', position: 'opposed', summary: 'Runway AI trained its Gen-3 Alpha video model on over 100,000 YouTube videos scraped without permission from channels including Disney, Netflix, Pixar, The New Yorker, and VICE News, as revealed by a leaked internal planning document in 2024. The data collection violated YouTube\'s Terms of Service. A class-action lawsuit was filed in California federal court in February 2026 by YouTube creator David Gardner alleging Runway circumvented copyright protections.', source_url: 'https://venturebeat.com/ai/runway-faces-backlash-after-report-of-copying-ai-video-training-data-from-youtube', source_type: 'news', stance_date: '2024-07-01', verified: true },
]
...
export const stats: Stat[] = [
  ...
  // Daily populate: 2026-05-26
  { id: 'stat-39', entity_type: 'company', entity_id: '14', stat_type: 'layoffs', headline: '10% workforce cut after CEO resignation', details: 'Stability AI laid off approximately 20 employees (10% of its ~200-person global staff) in April 2024, weeks after founder and CEO Emad Mostaque resigned amid investor pressure. Incoming co-CEOs Shan Shan Wong and Christian Laforte targeted operational roles to reduce costs as the company sought new investment.', source_url: 'https://siliconangle.com/2024/04/18/stability-ai-lay-off-10-staff-wake-resignation-ceo/', source_type: 'news', stat_date: '2024-04-18', verified: true, numeric_value: 20, percentage_value: 10, monetary_value: null, metadata: { rounds: 1 } },
]
