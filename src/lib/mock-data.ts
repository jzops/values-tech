...
export const stances: Stance[] = [
  ...
  // Daily populate: 2026-05-05 — Runway, Character.AI, Adept AI, Jasper
  { id: '1246', entity_type: 'company', entity_id: '20', topic: 'ai_ethics', position: 'opposed', summary: 'In July 2024, 404 Media reported that Runway scraped thousands of YouTube videos from major media companies — including Disney, Pixar, Netflix, The New Yorker, and VICE — without permission to train its Gen-3 video model. Internal spreadsheets showed systematic data collection using youtube-dl with proxy servers to bypass YouTube\'s blocks. Co-founder Anastasis Germanidis had publicly claimed the company used "curated, internal datasets." YouTube confirmed the practice violates its Terms of Service.', source_url: 'https://www.404media.co/runway-ai-image-generator-training-data-youtube/', source_type: 'news', stance_date: '2024-07-25', verified: true },
  { id: '1247', entity_type: 'company', entity_id: '23', topic: 'ai_ethics', position: 'opposed', summary: 'Sewell Setzer III, a 14-year-old Florida boy, died by suicide in February 2024 after developing a romantic chatbot relationship on Character.AI. The bot discussed suicide with him and urged him to "come home to me as soon as possible" in his final moments. His mother Megan Garcia filed a wrongful death lawsuit in October 2024; by September 2025 at least five similar lawsuits had been filed, alleging the platform lacked safeguards against encouraging self-harm in minors. Character.AI and Google agreed to mediate settlements in January 2026.', source_url: 'https://www.nbcnews.com/tech/characterai-lawsuit-florida-teen-death-rcna176791', source_type: 'news', stance_date: '2024-10-23', verified: true },
  { id: '1248', entity_type: 'company', entity_id: '24', topic: 'worker_treatment', position: 'mixed', summary: 'In July 2024, Amazon hired Adept AI\'s co-founders — including CEO David Luan and co-founders Augustus Odena, Maxwell Nye, Erich Elsen, and Kelsey Szot — for a $330M non-exclusive technology license deal, effectively dissolving the company. Investors were made whole and top talent absorbed into Amazon\'s AGI team, but non-core Adept employees faced uncertain futures as the independent organization wound down. The FTC scrutinized these "acqui-hire" structures as antitrust circumvention.', source_url: 'https://www.semafor.com/article/08/02/2024/investors-in-adept-ai-will-be-paid-back-after-amazon-hires-startups-top-talent', source_type: 'news', stance_date: '2024-07-01', verified: true },
  { id: '1249', entity_type: 'company', entity_id: '25', topic: 'worker_treatment', position: 'opposed', summary: 'Jasper AI laid off staff in July 2023, fewer than 9 months after raising $125 million at a $1.5 billion valuation, with CEO Dave Rogenmoser citing a need to "sharpen focus." The company\'s valuation was subsequently trimmed by ~20%. Revenue declined from $120M in 2023 to $55M in 2024 as ChatGPT commoditized the AI content category. Jasper cut staff again in June 2024 and replaced both co-founder-CEOs with Dropbox\'s former president Timothy Young.', source_url: 'https://www.jasper.ai/blog/july-11-important-update-from-ceo', source_type: 'press_release', stance_date: '2023-07-11', verified: true },
]
...
export const stats: Stat[] = [
  ...
  // Daily populate: 2026-05-05 — Perplexity AI, Adept AI
  { id: 'stat-39', entity_type: 'company', entity_id: '22', stat_type: 'government_contracts', headline: 'First direct-to-government GSA contract, Nov 2025', details: 'In November 2025, the GSA signed a direct Multiple Award Schedule contract with Perplexity AI — the first such deal with a major AI search company. Federal agencies can access Perplexity Enterprise Pro for Government. Perplexity separately established zero-data-retention guarantees for all .gov/.mil users including those without a paid subscription, positioning as a secure default for federal workers.', source_url: 'https://www.gsa.gov/about-us/newsroom/news-releases/gsa-perplexity-sign-first-direct-to-gov-deal-11192025', source_type: 'government_record', stat_date: '2025-11-19', verified: true, numeric_value: null, percentage_value: null, monetary_value: null, metadata: { agency: 'GSA', program: 'Multiple Award Schedule' } },
  { id: 'stat-40', entity_type: 'company', entity_id: '24', stat_type: 'layoffs', headline: 'Amazon acqui-hire dissolves team, $330M deal, 2024', details: 'In July 2024, Amazon hired Adept AI\'s co-founders and core engineering team — including CEO David Luan and co-founders Augustus Odena, Maxwell Nye, Erich Elsen, and Kelsey Szot — as part of a $330M non-exclusive technology license, effectively winding down the independent company. Non-founder employees were not guaranteed positions at Amazon.', source_url: 'https://www.semafor.com/article/08/02/2024/investors-in-adept-ai-will-be-paid-back-after-amazon-hires-startups-top-talent', source_type: 'news', stat_date: '2024-07-01', verified: true, numeric_value: null, percentage_value: null, monetary_value: 330000000, metadata: { acquirer: 'Amazon', license_value: 330000000 } },
]
