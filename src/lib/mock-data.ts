...
export const stances: Stance[] = [
  ...
  // === Daily populate: 2026-06-26 ===
  { id: '1254', entity_type: 'company', entity_id: '22', topic: 'data_privacy', position: 'opposed', summary: 'A proposed class action filed April 1, 2026 in San Francisco federal court alleged Perplexity AI secretly embedded third-party trackers—Meta Pixel, Google Ads, Google DoubleClick, and Meta\'s Conversions API—that transmitted user conversations, email addresses, IP addresses, and device identifiers to Meta and Google for ad targeting. The complaint alleged chats were shared even when users activated Perplexity\'s "Incognito" mode. The proposed class covers all free-tier users from December 7, 2022, through February 4, 2026. Perplexity said it had not been served.', source_url: 'https://www.claimsjournal.com/news/national/2026/04/01/336634.htm', source_type: 'news', stance_date: '2026-04-01', verified: true },
  { id: '1255', entity_type: 'company', entity_id: '20', topic: 'data_privacy', position: 'opposed', summary: 'By March 2026, four separate DMCA lawsuits had been filed against Runway AI by YouTube creators alleging the company circumvented YouTube\'s technical access controls to scrape videos for training its Gen-3 AI model without creator consent. Cases include Gardner v. Runway and Ace Cam v. Runway, each asserting DMCA anti-circumvention violations. A leaked internal Runway spreadsheet from 2024 had catalogued over 3,900 channels—including Taylor Swift, Pixar, and The New Yorker—targeted for training data harvesting.', source_url: 'https://www.tradingview.com/news/reuters.com,2026:newsml_L6N3ZK172:0-youtuber-sues-runway-ai-in-latest-copyright-class-action-over-ai-training/', source_type: 'news', stance_date: '2026-02-24', verified: true },
  { id: '1256', entity_type: 'company', entity_id: '38', topic: 'worker_treatment', position: 'supported', summary: 'During Affirm\'s Q3 FY2026 earnings call on May 7, 2026, CEO Max Levchin stated "We are not planning AI-related layoffs, full stop," explicitly breaking with the industry trend of using AI adoption as justification for headcount reductions. Levchin called layoffs "a terrible thing to do" and publicly criticized peers who use AI as cover for workforce cuts: "Own your bad decisions." Affirm reported $1.04B in revenue for Q3 FY2026, up 33% year-over-year, while expanding AI use in software engineering without reducing staff.', source_url: 'https://www.americanbanker.com/payments/news/affirms-levchin-does-not-plan-ai-layoffs', source_type: 'news', stance_date: '2026-05-07', verified: true },
  { id: '1257', entity_type: 'company', entity_id: '18', topic: 'government_contracts', position: 'supported', summary: 'On May 6, 2026, the Pentagon awarded Scale AI a $500M contract through the DOD\'s Chief Digital and Artificial Intelligence Office (CDAO)—five times larger than its prior $100M September 2025 deal. The expanded agreement covers computer vision, generative AI decision support, and data operations under "Thunderforge," the military\'s flagship AI-agent program for campaign planning and theater-wide resource allocation. CEO Alexandr Wang described working with the military as a "moral imperative." Meta holds a 49% stake in Scale AI.', source_url: 'https://scale.com/blog/scale-ai-pentagon-cdao-500-million-agreement', source_type: 'company_website', stance_date: '2026-05-06', verified: true },
]
...
export const stats: Stat[] = [
  ...
  // === Daily populate: 2026-06-26 ===
  { id: 'stat-43', entity_type: 'company', entity_id: '18', stat_type: 'government_contracts', headline: '$500M Pentagon contract — 5× expansion of September 2025 Thunderforge deal', details: 'On May 6, 2026, the DOD awarded Scale AI a $500M agreement through its Chief Digital and Artificial Intelligence Office (CDAO), expanding the Thunderforge program. The contract is five times the size of Scale AI\'s September 2025 $100M deal and covers computer vision, generative AI decision support, and data operations across DOD use cases in the Indo-Pacific and Europe. Meta Platforms holds a 49% stake in Scale AI, acquired in 2025.', source_url: 'https://scale.com/blog/scale-ai-pentagon-cdao-500-million-agreement', source_type: 'company_website', stat_date: '2026-05-06', verified: true, numeric_value: null, percentage_value: null, monetary_value: 500000000, metadata: { prior_contract_amount: 100000000, prior_contract_date: '2025-09-01', program: 'Thunderforge', investor: 'Meta (49%)' } },
]
