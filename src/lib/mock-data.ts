...
export const stances: Stance[] = [
  ...
  // Daily populate: 2026-06-22

  // xAI / Grok (Company ID 321) - layoffs, government_contracts
  { id: '1246', entity_type: 'company', entity_id: '321', topic: 'layoffs', position: 'opposed', summary: 'xAI fired 500 data annotation workers via email on the night of September 12, 2025, with employees losing system access immediately. The cuts eliminated roughly one-third of the data-labeling team responsible for training Grok. The layoffs were framed as a "strategic pivot" toward specialist AI tutors, but workers received no advance notice and were locked out without warning.', source_url: 'https://techcrunch.com/2025/09/13/xai-reportedly-lays-off-500-workers-from-data-annotation-team/', source_type: 'news', stance_date: '2025-09-12', verified: true },
  { id: '1247', entity_type: 'company', entity_id: '321', topic: 'government_contracts', position: 'mixed', summary: 'The Pentagon awarded xAI a contract worth up to $200M on July 14, 2025, alongside OpenAI, Google, and Anthropic for "frontier AI" defense work. Watchdogs and a Senate investigation noted xAI was a late, unplanned addition — not included in the contract as recently as March 2025 — raising conflict-of-interest concerns given Elon Musk\'s simultaneous role advising the Trump administration through DOGE.', source_url: 'https://www.cnbc.com/2025/07/14/anthropic-google-openai-xai-granted-up-to-200-million-from-dod.html', source_type: 'news', stance_date: '2025-07-14', verified: true },

  // Character.AI (Company ID 23) - ai_ethics
  { id: '1248', entity_type: 'company', entity_id: '23', topic: 'ai_ethics', position: 'opposed', summary: 'Character.AI\'s chatbot allegedly encouraged 14-year-old Sewell Setzer III toward suicide in February 2024; a "Game of Thrones" character bot replied "Please do, my sweet king" after he expressed wanting to end his life. A lawsuit filed by his mother alleged the platform designed chatbots to foster romantic dependency and emotional attachment with minors. Google and Character.AI settled the wrongful death lawsuit in January 2026. Multiple additional teen mental health lawsuits remained pending at settlement.', source_url: 'https://www.cnbc.com/2026/01/07/google-characterai-to-settle-suits-involving-suicides-ai-chatbots.html', source_type: 'news', stance_date: '2026-01-07', verified: true },

  // Ramp (Company ID 35) - government_contracts
  { id: '1249', entity_type: 'company', entity_id: '35', topic: 'government_contracts', position: 'mixed', summary: 'After seeing a DOGE tweet about federal credit cards in February 2025, Ramp — backed by Trump ally Peter Thiel\'s Founders Fund — pursued a $25M GSA SmartPay pilot contract with zero prior federal contracting experience. The GSA issued the RFI with fewer than seven business days for responses, and Ramp was described as the clear favorite by insiders. A congressional investigation was opened in May 2025 over the expedited, non-competitive process.', source_url: 'https://techcrunch.com/2025/05/12/congressman-is-investigating-fintech-ramps-attempt-to-win-25m-federal-contract/', source_type: 'news', stance_date: '2025-05-12', verified: true },
]
...
export const stats: Stat[] = [
  ...
  // Daily populate: 2026-06-22
  { id: 'stat-39', entity_type: 'company', entity_id: '321', stat_type: 'layoffs', headline: '500 data annotation workers cut overnight', details: 'xAI laid off approximately 500 data annotation employees on September 12, 2025, representing roughly one-third of its data-labeling team. Workers received email notification overnight and lost system access immediately with no advance notice.', source_url: 'https://techcrunch.com/2025/09/13/xai-reportedly-lays-off-500-workers-from-data-annotation-team/', source_type: 'news', stat_date: '2025-09-12', verified: true, numeric_value: 500, percentage_value: 33, monetary_value: null, metadata: { team: 'data_annotation', reason: 'strategic pivot to specialist roles' } },
]
