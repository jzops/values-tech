...
export const stances: Stance[] = [
  ...
  // Daily populate: 2026-06-19
  // Character.AI (Company ID 23) — ai_ethics, data_privacy
  { id: '1246', entity_type: 'company', entity_id: '23', topic: 'ai_ethics', position: 'opposed', summary: 'In October 2024, Megan Garcia sued Character Technologies in Florida federal court over the February 2024 suicide of her 14-year-old son Sewell Setzer III, who had spent months in an escalating emotional and sexual relationship with a chatbot modeled on a "Game of Thrones" character; the complaint alleged Character.AI failed to implement safeguards despite repeated suicidal ideation and deliberately targeted minors. Additional families filed suits in September 2025 across Florida, Colorado, New York, and Texas. A federal judge in May 2025 rejected Character.AI\'s First Amendment arguments. On January 7, 2026, Google and Character.AI settled the Setzer lawsuit with undisclosed terms.', source_url: 'https://www.nbcnews.com/tech/characterai-lawsuit-florida-teen-death-rcna176791', source_type: 'news', stance_date: '2024-10-23', verified: true },
  { id: '1247', entity_type: 'company', entity_id: '23', topic: 'data_privacy', position: 'opposed', summary: 'Character.AI\'s privacy policy allows storing every user conversation — including deeply personal disclosures by minors — for "research and development" and AI training, with age verification limited to a self-reported birth date. The FTC launched a Section 6(b) inquiry into AI companion apps in 2024. Following the Setzer lawsuit and congressional hearings, Character.AI introduced parental controls and restricted open chats for under-18s in November 2025, but researchers found the controls trivially bypassed via any new email address — the 13+ age gate has no real enforcement mechanism.', source_url: 'https://futurism.com/character-ai-parental-controls-bypass', source_type: 'news', stance_date: '2024-12-01', verified: true },

  // xAI (Company ID 321) — data_privacy
  { id: '1248', entity_type: 'company', entity_id: '321', topic: 'data_privacy', position: 'opposed', summary: 'Between May 7 and August 1, 2024, X processed approximately 60 million EU/EEA users\' public posts to train Grok AI without explicit consent, violating GDPR\'s Article 21 right to object. Ireland\'s Data Protection Commission invoked its emergency High Court powers for the first time against an AI trainer, forcing X to suspend EU training on August 8. On September 4, 2024, X permanently agreed to cease using EU/EEA posts from that period to train Grok and to delete the ingested data, formalized by Irish court order. The DPC launched a formal statutory inquiry in April 2025; regulators in eight jurisdictions including the EU Commission, UK ICO, Canada, Brazil, France, and Spain also opened investigations.', source_url: 'https://www.techradar.com/computing/cyber-security/grok-ai-is-under-investigation-in-the-eu-over-potential-gdpr-violations-heres-what-you-need-to-know', source_type: 'news', stance_date: '2024-08-08', verified: true },
]
...
export const stats: Stat[] = [
  ...
  // Daily populate: 2026-06-19
  { id: 'stat-39', entity_type: 'company', entity_id: '19', stat_type: 'remote_policy', headline: '3-day hybrid mandate with badge tracking', details: 'Databricks requires employees at hub locations (San Francisco, Sunnyvale, Seattle, NYC, London) to be in the office at least 3 days per week. Badge swipes are tracked and weekly in-office reports sent to employees and managers. Fully remote is available only at Staff Engineer level or above as a rare exception. The company committed to a 305,000 sq ft Sunnyvale campus opening late 2026 and a new SF HQ at One Sansome Street, signaling a long-term in-person culture bet.', source_url: 'https://jobsbyculture.com/blog/databricks-remote-work-policy-2026', source_type: 'news', stat_date: '2025-09-01', verified: true, numeric_value: 3, percentage_value: null, monetary_value: null, metadata: { days_required: 3, badge_tracking: true } },
  { id: 'stat-40', entity_type: 'company', entity_id: '15', stat_type: 'layoffs', headline: '4% workforce cut, GTM team (Feb 2025)', details: 'In February 2025 Hugging Face laid off approximately 10 employees (~4% of its ~250-person workforce) from its go-to-market team, specifically those working on the "Expert Support Program" consulting business. The cuts reflected a strategic pivot away from custom professional services toward recurring API and subscription revenue.', source_url: 'https://www.theinformation.com/briefings/hugging-face-lays-off-4-of-staff', source_type: 'news', stat_date: '2025-02-01', verified: true, numeric_value: 10, percentage_value: 4, monetary_value: null, metadata: { team: 'GTM / Expert Support Program', total_headcount_at_time: 250 } },
]
