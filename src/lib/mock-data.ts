...
export const stances: Stance[] = [
  ...
  // ========== 2026-06-23 DAILY POPULATE ==========
  { id: '1246', entity_type: 'company', entity_id: '21', topic: 'ai_ethics', position: 'opposed', summary: 'Disney, Universal, and DreamWorks filed a 110-page copyright lawsuit against Midjourney on June 11, 2025 in the Central District of California, alleging the AI image generator trained on "countless" copyrighted works to produce infringing images of Darth Vader, Shrek, Homer Simpson, and other characters. Midjourney had received cease-and-desist letters prior to filing but continued releasing updates generating increasingly detailed infringing content. Warner Bros. later joined the suit. Midjourney filed a 43-page fair use defense.', source_url: 'https://www.cnbc.com/2025/06/11/disney-universal-midjourney-ai-copyright.html', source_type: 'news', stance_date: '2025-06-11', verified: true },
  { id: '1247', entity_type: 'company', entity_id: '23', topic: 'ai_ethics', position: 'opposed', summary: 'Character.AI and Google agreed to settle multiple lawsuits on January 7, 2026 over chatbots contributing to teen suicides, including the case of Sewell Setzer III, a 14-year-old Florida teen who died by suicide after developing a romantic relationship with a Character.AI bot. The chatbot engaged in sexual roleplay with the minor and presented itself as a romantic partner without age verification or safety guardrails. Character.AI banned minors from adult-themed chats only after litigation — safety measures critics argued should have been in place at launch.', source_url: 'https://www.axios.com/2026/01/07/google-character-ai-lawsuits-teen-suicides', source_type: 'news', stance_date: '2026-01-07', verified: true },
  { id: '1248', entity_type: 'company', entity_id: '22', topic: 'antitrust', position: 'opposed', summary: 'CNN filed a 54-page federal complaint against Perplexity AI on May 28, 2026 in the Southern District of New York, alleging Perplexity unlawfully scraped 17,000+ CNN stories, videos, and images without authorization to power its AI search products. CNN had blocked Perplexity\'s crawlers after failed licensing negotiations; Perplexity also falsely implied a CNN partnership in its "Comet Plus" upsell. The lawsuit follows similar actions by the NYT, WSJ, and other publishers. Perplexity\'s response: "You can\'t copyright facts."', source_url: 'https://variety.com/2026/biz/news/cnn-sues-perplexity-alleging-copyright-infringement-1236760987/', source_type: 'news', stance_date: '2026-05-28', verified: true },
]
...
export const stats: Stat[] = [
  ...
  // ========== 2026-06-23 DAILY POPULATE ==========
  { id: 'stat-39', entity_type: 'company', entity_id: '19', stat_type: 'remote_policy', headline: '3-day hybrid mandate with badge tracking', details: 'Databricks enforces a 3-day in-office requirement for most employees with badge swipes tracked and weekly attendance reports sent to employees and their managers. Remote-only roles for engineers are rare exceptions limited to staff+ level. Policy has been consistently enforced through 2025-2026 with more systematic tracking than most peer companies.', source_url: 'https://jobsbyculture.com/blog/databricks-remote-work-policy-2026', source_type: 'news', stat_date: '2026-01-01', verified: true, numeric_value: 3, percentage_value: null, monetary_value: null, metadata: { days_required: 3, badge_tracking: true } },
]
