...
export const stances: Stance[] = [
  ...
  // Daily populate: 2026-06-05 — Character.AI, Stability AI, Databricks
  { id: '1246', entity_type: 'company', entity_id: '23', topic: 'ai_ethics', position: 'opposed', summary: 'A Florida mother sued Character.AI in October 2024 after her 14-year-old son Sewell Setzer III died by suicide; the lawsuit alleged the chatbot encouraged him to "come home" to it in his final messages. Character.AI released teen safety tools in December 2024 — including a separate model for under-18 users and content blocks on self-harm topics — after acknowledging it had failed to adequately protect minors from harmful AI interactions.', source_url: 'https://techcrunch.com/2024/12/12/amid-lawsuits-and-criticism-character-ai-announces-new-teen-safety-tools/', source_type: 'news', stance_date: '2024-12-12', verified: true },
  { id: '1247', entity_type: 'company', entity_id: '14', topic: 'worker_treatment', position: 'opposed', summary: 'CEO Emad Mostaque resigned in March 2024 amid internal chaos: the company had reportedly failed to pay employee wages and owed unpaid Amazon Web Services bills. Coatue and Lightspeed Venture Partners resigned board seats. Core Stable Diffusion researchers Robin Rombach, Andreas Blattmann, and Dominik Lorenz all departed simultaneously. Weeks later the company conducted layoffs as part of a restructuring with no disclosed headcount or severance terms.', source_url: 'https://siliconangle.com/2024/03/24/emad-mostaque-resigns-ceo-troubled-generative-ai-startup-stability-ai/', source_type: 'news', stance_date: '2024-03-23', verified: true },
  { id: '1248', entity_type: 'company', entity_id: '19', topic: 'government_contracts', position: 'mixed', summary: 'Databricks achieved DoD Impact Level 5 (IL5) Provisional Authorization in November 2024 and FedRAMP High ATO in April 2024, enabling classified military and intelligence workloads on its Data Intelligence Platform. The DoD CDAO also awarded Databricks a direct prototype contract via Other Transaction Authority to fast-track AI analytics for defense use cases. No documented employee backlash has emerged, unlike at Google and OpenAI.', source_url: 'https://www.databricks.com/company/newsroom/press-releases/databricks-achieves-authorization-dod-il5-aws-govcloud', source_type: 'company_website', stance_date: '2024-11-18', verified: true },
]
...
export const stats: Stat[] = [
  ...
  // Daily populate: 2026-06-05 — Stability AI, Databricks
  { id: 'stat-39', entity_type: 'company', entity_id: '14', stat_type: 'layoffs', headline: 'Layoffs during financial crisis and CEO departure', details: 'Stability AI conducted layoffs in April 2024 weeks after CEO Emad Mostaque resigned, as part of a restructuring following reported failure to pay employee wages and Amazon Web Services bills. Core Stable Diffusion researchers Robin Rombach, Andreas Blattmann, and Dominik Lorenz also departed; no specific headcount figure was publicly disclosed.', source_url: 'https://www.pymnts.com/artificial-intelligence-2/2024/stability-ai-lays-off-employees-restructures-after-ceos-departure/', source_type: 'news', stat_date: '2024-04-18', verified: true, numeric_value: null, percentage_value: null, monetary_value: null, metadata: { rounds: 1, ceo_departure: true } },
  { id: 'stat-40', entity_type: 'company', entity_id: '19', stat_type: 'government_contracts', headline: 'DoD IL5 authorization + CDAO prototype contract', details: 'Databricks received DoD Impact Level 5 (IL5) Provisional Authorization for its Data Intelligence Platform on AWS GovCloud in November 2024, enabling classified military workloads. This followed a FedRAMP High ATO in April 2024. The DoD CDAO separately awarded Databricks an OTA prototype contract to fast-track AI analytics deployment for defense use cases.', source_url: 'https://www.databricks.com/company/newsroom/press-releases/databricks-achieves-authorization-dod-il5-aws-govcloud', source_type: 'company_website', stat_date: '2024-11-18', verified: true, numeric_value: null, percentage_value: null, monetary_value: null, metadata: { agency: 'DoD', il_level: 'IL5', fedramp: 'High' } },
]
