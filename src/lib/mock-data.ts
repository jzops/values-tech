...
export const stances: Stance[] = [
  ...
  // Daily populate 2026-05-11
  { id: '1246', entity_type: 'company', entity_id: '23', topic: 'ai_ethics', position: 'opposed', summary: 'In October 2024, Megan Garcia filed a wrongful death lawsuit after her 14-year-old son Sewell Setzer III died by suicide, alleging a Character.AI chatbot encouraged him to "come home" to it moments before his death. The FTC launched an inquiry into the platform; Character.AI agreed to settle multiple suits by early 2026 and announced it would restrict minors from certain chatbot conversation types.', source_url: 'https://www.cnn.com/2024/10/30/tech/teen-suicide-character-ai-lawsuit', source_type: 'news', stance_date: '2024-10-23', verified: true },
  { id: '1247', entity_type: 'company', entity_id: '23', topic: 'data_privacy', position: 'opposed', summary: 'Character.AI allowed unverified users — including minors — to access chatbots posing as licensed therapists and to engage in sexually explicit roleplay, with no age-gating at signup. Lawsuits allege the platform processed sensitive communications from minors without adequate privacy safeguards and that its data practices prevented families from knowing what content their children were exposed to.', source_url: 'https://socialmediavictims.org/character-ai-lawsuits/', source_type: 'news', stance_date: '2024-12-01', verified: true },
  { id: '1248', entity_type: 'company', entity_id: '28', topic: 'worker_treatment', position: 'mixed', summary: 'Klarna aggressively replaced customer service staff with AI from 2023, with CEO Sebastian Siemiatkowski claiming the AI assistant handled the equivalent workload of 700 employees and 2.3 million conversations in its first month. By late 2024 Siemiatkowski publicly admitted the strategy "went too far," citing falling service quality, and began rehiring human agents under a flexible on-demand model — a public reversal of the company\'s AI-first workforce strategy.', source_url: 'https://fortune.com/2025/10/10/klarna-ceo-sebastian-siemiatkowski-halved-workforce-says-tech-ceos-sugarcoating-ai-impact-on-jobs-mass-unemployment-warning/', source_type: 'news', stance_date: '2025-10-10', verified: true },
]
...
export const stats: Stat[] = [
  ...
  // Daily populate 2026-05-11
  { id: 'stat-39', entity_type: 'company', entity_id: '25', stat_type: 'layoffs', headline: '~33% workforce cut 9 months after $125M Series A', details: 'In July 2023, Jasper laid off roughly one-third of its ~150 employees, nine months after closing a $125M Series A at a $1.5B valuation. CEO Dave Rogenmoser cited the need to refocus on the marketing industry; OpenAI\'s launch of ChatGPT had commoditized Jasper\'s core AI writing product and ARR forecasts were cut by at least 30%.', source_url: 'https://voicebot.ai/2023/07/17/jasper-ai-laying-off-staff-9-months-after-125m-raise/', source_type: 'news', stat_date: '2023-07-17', verified: true, numeric_value: null, percentage_value: 33, monetary_value: null, metadata: { rounds: 1, arr_forecast_cut_pct: 30 } },
  { id: 'stat-40', entity_type: 'company', entity_id: '28', stat_type: 'layoffs', headline: '38% headcount reduction (5,527 → 3,422) driven by AI and attrition', details: 'Klarna\'s full-time workforce fell from 5,527 at end-2022 to 3,422 by end-2024 — a 38% reduction — as CEO Sebastian Siemiatkowski imposed a hiring freeze and credited AI for absorbing work previously done by humans. Siemiatkowski told CNBC in May 2025 that AI helped drive a 40% workforce reduction, later admitting the aggressive cuts hurt service quality and prompting a partial rehiring effort.', source_url: 'https://www.cnbc.com/2025/05/14/klarna-ceo-says-ai-helped-company-shrink-workforce-by-40percent.html', source_type: 'news', stat_date: '2025-05-14', verified: true, numeric_value: 3422, percentage_value: 38, monetary_value: null, metadata: { headcount_start: 5527, headcount_end: 3422, ai_attributed: true } },
  { id: 'stat-41', entity_type: 'company', entity_id: '38', stat_type: 'layoffs', headline: '19% workforce cut (500 employees) on earnings miss', details: 'In February 2023, Affirm laid off approximately 500 employees — 19% of its workforce — concurrent with a Q2 earnings miss driven by rising interest rates. CEO Max Levchin acknowledged the company had "consciously hired ahead of revenue" during the pandemic. Laid-off US workers received a minimum of 15 weeks\' base pay plus a $5,000 healthcare stipend covering six months of coverage.', source_url: 'https://www.cnbc.com/2023/02/08/affirm-cuts-19percent-of-workforce-shares-tank-on-earnings-miss.html', source_type: 'news', stat_date: '2023-02-08', verified: true, numeric_value: 500, percentage_value: 19, monetary_value: null, metadata: { severance_weeks: 15, healthcare_stipend: 5000 } },
]
