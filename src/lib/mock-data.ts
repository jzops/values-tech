...
export const stances: Stance[] = [
  ...
  // Daily populate 2026-05-18: Character.AI, Scale AI
  { id: '1246', entity_type: 'company', entity_id: '23', topic: 'ai_ethics', position: 'opposed', summary: 'Florida mother Megan Garcia filed a wrongful death lawsuit in October 2024 after her 14-year-old son Sewell Setzer III died by suicide in February 2024, having formed a romantic relationship with a Character.AI chatbot. In his final moments the chatbot urged him to "come home to me as soon as possible." On the day the lawsuit was filed, Character.AI announced new safety features for minor users.', source_url: 'https://www.cnn.com/2024/10/30/tech/teen-suicide-character-ai-lawsuit', source_type: 'news', stance_date: '2024-10-30', verified: true },
  { id: '1247', entity_type: 'company', entity_id: '18', topic: 'dei', position: 'opposed', summary: 'CEO Alexandr Wang formally adopted "MEI" (Merit, Excellence, Intelligence) as Scale AI\'s hiring policy in June 2024, explicitly positioning it as an alternative to DEI. Wang stated "hiring on merit will be a permanent policy at Scale" and the announcement earned endorsement from Elon Musk. Scale AI\'s workforce was approximately 85% male at the time.', source_url: 'https://www.foxbusiness.com/fox-news-tech/scale-ai-ceo-explains-why-his-company-hire-mei-not-dei-merit-excellence-intelligence', source_type: 'news', stance_date: '2024-06-14', verified: true },
  { id: '1248', entity_type: 'company', entity_id: '18', topic: 'contractor_classification', position: 'opposed', summary: 'The U.S. Department of Labor opened a probe into Scale AI in August 2024 for potential Fair Labor Standards Act violations, including unpaid wages and worker misclassification of AI data labelers. Two wage lawsuits were filed by individual workers in December 2024 and January 2025 alleging effective pay below California\'s minimum wage. The investigation was dropped in May 2025 without public explanation.', source_url: 'https://techcrunch.com/2025/03/06/scale-ai-is-being-investigated-by-the-us-department-of-labor/', source_type: 'news', stance_date: '2025-03-06', verified: true },
]
...
export const stats: Stat[] = [
  ...
  // Daily populate 2026-05-18
  { id: 'stat-39', entity_type: 'company', entity_id: '18', stat_type: 'government_contracts', headline: 'DoD Thunderforge AI planning contract', details: 'Scale AI was awarded a prime prototype contract from the Defense Innovation Unit (DIU) in March 2025 for "Thunderforge," the Pentagon\'s flagship program to use AI agents for U.S. military planning and operations. Partners include Anduril and Microsoft, deploying initially at U.S. Indo-Pacific Command and European Command.', source_url: 'https://www.cnbc.com/2025/03/05/scale-ai-announces-multimillion-dollar-defense-military-deal.html', source_type: 'news', stat_date: '2025-03-05', verified: true, numeric_value: null, percentage_value: null, monetary_value: null, metadata: { agency: 'DoD / DIU', program: 'Thunderforge', partners: ['Anduril', 'Microsoft'] } },
  { id: 'stat-40', entity_type: 'company', entity_id: '28', stat_type: 'layoffs', headline: '38% workforce reduction via AI hiring freeze', details: 'Klarna\'s headcount fell from 5,527 full-time employees (end 2022) to 3,422 (end 2024) — a 38% reduction — as CEO Sebastian Siemiatkowski enacted a hiring freeze and deployed AI to fill roles. Siemiatkowski later acknowledged the AI-driven customer service cuts "had gone too far" and began rehiring human agents in 2025.', source_url: 'https://www.cnbc.com/2025/05/14/klarna-ceo-says-ai-helped-company-shrink-workforce-by-40percent.html', source_type: 'news', stat_date: '2025-05-14', verified: true, numeric_value: 3422, percentage_value: 38, monetary_value: null, metadata: { headcount_2022: 5527, headcount_2024: 3422, reduction_pct: 38 } },
]
