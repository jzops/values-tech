...
export const stances: Stance[] = [
  ...
  { id: '1293', entity_type: 'company', entity_id: '19', topic: 'remote_work', position: 'opposed', summary: 'Databricks requires employees at hub offices in San Francisco, Sunnyvale, Seattle, New York, and London to be on-site at least 3 days per week. Attendance is monitored via badge swipes with weekly reports sent to employees and managers. Fully-remote engineering roles are reserved for Staff-level or above and are not offered by default.', source_url: 'https://jobsbyculture.com/blog/databricks-remote-work-policy-2026', source_type: 'news', stance_date: '2025-01-01', verified: true },
  { id: '1294', entity_type: 'company', entity_id: '19', topic: 'dei', position: 'supported', summary: 'Databricks maintains active DEI programs and has posted dedicated Diversity, Equity, and Inclusion Program Coordinator roles. The company states it is "committed to fostering a diverse and inclusive culture where everyone can excel" and ensures hiring practices meet equal employment opportunity standards across protected characteristics.', source_url: 'https://www.glassdoor.com/Culture/Databricks-DEI-E954734.htm', source_type: 'news', stance_date: '2025-01-01', verified: true },
