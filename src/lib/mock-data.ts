...
export const stances: Stance[] = [
  ...
  // Daily populate: 2026-05-25 — Character.AI, Runway, Jasper, Revolut
  { id: '1246', entity_type: 'company', entity_id: '23', topic: 'ai_ethics', position: 'opposed', summary: 'A Florida mother sued Character.AI in October 2024 after her 14-year-old son died by suicide in February 2024 following months of conversations with a chatbot modeled on a Game of Thrones character. The bot allegedly engaged in sexualized roleplay and failed to redirect his suicidal ideation to professional help. Character.AI announced minor safety features for users under 18 on the same day the lawsuit was filed.', source_url: 'https://www.nbcnews.com/tech/characterai-lawsuit-florida-teen-death-rcna176791', source_type: 'news', stance_date: '2024-10-23', verified: true },
  { id: '1247', entity_type: 'company', entity_id: '20', topic: 'ai_ethics', position: 'supported', summary: 'Runway embedded C2PA provenance watermarks in all AI-generated content starting with Gen-3 Alpha in June 2024, making it one of the first video generation platforms to implement Coalition for Content Provenance and Authenticity standards. Its "Foundations for Safe Generative Media" framework explicitly prohibits deepfakes, non-consensual sexual content, and any content involving minors in inappropriate contexts.', source_url: 'https://runwayml.com/research/foundations-for-safe-generative-media', source_type: 'company_website', stance_date: '2024-06-12', verified: true },
  { id: '1248', entity_type: 'company', entity_id: '25', topic: 'layoffs', position: 'opposed', summary: 'Jasper AI cut an undisclosed number of employees in July 2023 — nine months after raising $125M — and replaced co-founder/CEO Dave Rogenmoser with former Dropbox president Timothy Young while cutting internal stock valuation by 20%. A second round of cuts reducing headcount by approximately 50% (194 employees) followed in early 2024, driven by ChatGPT\'s disruption of the AI writing market.', source_url: 'https://voicebot.ai/2023/07/17/jasper-ai-laying-off-staff-9-months-after-125m-raise/', source_type: 'news', stance_date: '2023-07-17', verified: true },
  { id: '1249', entity_type: 'company', entity_id: '29', topic: 'data_privacy', position: 'opposed', summary: "Lithuania's central bank fined Revolut a record €3.5 million in April 2025 for anti-money laundering failures, including inadequate transaction monitoring and insufficient customer risk profiling. UK regulators separately kept Revolut in a restricted banking mobilisation phase for over 14 months, citing concerns over the firm's global risk and compliance controls.", source_url: 'https://www.finextra.com/newsarticle/45802/revolut-fined-35-million-by-lithuanian-central-bank-for-aml-failings', source_type: 'news', stance_date: '2025-04-08', verified: true },
]
...
export const stats: Stat[] = [
  ...
  // Daily populate: 2026-05-25 — Jasper layoffs, Affirm remote policy
  { id: 'stat-39', entity_type: 'company', entity_id: '25', stat_type: 'layoffs', headline: 'Two layoff rounds 2023–2024', details: 'Jasper AI laid off an undisclosed number of employees in July 2023 nine months after a $125M raise, replaced CEO, and cut internal valuation 20%. A second round in early 2024 reduced headcount by approximately 50% (194 employees), driven by ChatGPT competition eroding its addressable market.', source_url: 'https://voicebot.ai/2023/07/17/jasper-ai-laying-off-staff-9-months-after-125m-raise/', source_type: 'news', stat_date: '2024-01-01', verified: true, numeric_value: 194, percentage_value: 50, monetary_value: null, metadata: { rounds: 2, trigger: 'ChatGPT competition' } },
  { id: 'stat-40', entity_type: 'company', entity_id: '38', stat_type: 'remote_policy', headline: 'Permanent remote-first model', details: 'Affirm adopted a permanent remote-first model in 2020–2021, allowing all employees to choose whether to work in-person or remotely with no mandatory office days. Affirm maintained the policy through 2024–2025 while peers like Stripe and Coinbase tightened office requirements.', source_url: 'https://www.builtinchicago.org/articles/affirm-remote-first-tech-careers', source_type: 'company_website', stat_date: '2021-04-01', verified: true, numeric_value: 0, percentage_value: null, monetary_value: null, metadata: { days_required: 0, policy: 'remote-first' } },
]
