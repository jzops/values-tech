...
export const moreCompanies: Company[] = [
  ...
  { id: '301', name: 'Activision Blizzard', slug: 'activision-blizzard', logo_url: 'https://logo.clearbit.com/activisionblizzard.com', website: 'https://activisionblizzard.com', founded_year: 2008, headcount_range: '10,000+', funding_stage: 'Acquired', total_raised: null, industry: 'Gaming', description: 'Video game holding company. Call of Duty, World of Warcraft. Acquired by Microsoft 2023.' },
  { id: '302', name: 'Riot Games', slug: 'riot-games', logo_url: 'https://logo.clearbit.com/riotgames.com', website: 'https://riotgames.com', founded_year: 2006, headcount_range: '4,500+', funding_stage: 'Tencent', total_raised: null, industry: 'Gaming', description: 'League of Legends, Valorant developer. Owned by Tencent.' },
  { id: '303', name: 'Epic Games', slug: 'epic-games', logo_url: 'https://logo.clearbit.com/epicgames.com', website: 'https://epicgames.com', founded_year: 1991, headcount_range: '3,000+', funding_stage: 'Private', total_raised: 4400000000, industry: 'Gaming', description: 'Fortnite, Unreal Engine developer.' },
  { id: '304', name: 'Roblox', slug: 'roblox', logo_url: 'https://logo.clearbit.com/roblox.com', website: 'https://roblox.com', founded_year: 2004, headcount_range: '2,100+', funding_stage: 'Public', total_raised: null, industry: 'Gaming', description: 'User-generated gaming platform.' },
  { id: '305', name: 'Unity', slug: 'unity', logo_url: 'https://logo.clearbit.com/unity.com', website: 'https://unity.com', founded_year: 2004, headcount_range: '7,500+', funding_stage: 'Public', total_raised: null, industry: 'Gaming', description: 'Game development engine and platform.' },
]
